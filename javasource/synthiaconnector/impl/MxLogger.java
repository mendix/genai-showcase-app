 ...
 * Creation of a new instance requires thse class where the logging comes from as parameter (of the constructor).
 * <pre>
...
public class MxLogger {
	...
	static {
		MX_LOG_NODE_NAME = "Synthia Connector"; //log node name, e.g. name of your module
