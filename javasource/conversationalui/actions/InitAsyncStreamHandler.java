		...
		Core.addRequestHandler("llm-streaming", new RequestHandler() {
			...
			protected void processRequest(IMxRuntimeRequest req, IMxRuntimeResponse resp, String s) throws Exception {
	            ...
	            try {
	                ...
	                agentcommons.proxies.Version mxVersion = conversationalui.proxies.microflows.Microflows.chatContext_GetAgentVersion(getContext(), mxChatContext);
	                
	                if (mxVersion == null) {
	                    resp.getHttpServletResponse().setStatus(400);
	                    throw new NullPointerException("Agent Version could not be found.");
	                }
	                ...
	                boolean isAgentBuilderTest = agentcommons.proxies.microflows.Microflows.chatContext_IsAgentPlayground(ctx, mxChatContext);
	                ...
	                if (isAgentBuilderTest) {
		                ...
		                if (mxProviderConfig == null) {
		                	resp.getHttpServletResponse().setStatus(400);
		                	throw new NullPointerException("Active Provider Config could not be found.");
		                }
