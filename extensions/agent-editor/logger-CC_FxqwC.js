...
var Or = Object.defineProperty, Er = (o, e) => Or(o, "name", { value: e, configurable: !0 });
...
let Hr;
const ge = { name: "light", get devTokens() {
  return Hr ?? (Hr = new Z(this));
...
let Nr;
const Be = { name: "dark", get devTokens() {
  return Nr ?? (Nr = new Z(this));
}, get colorsAccentBlack() {
  return r.colorsDarkBrandGrey0;
}, get colorsAccentDefaultBlue() {
  return r.colorsDarkBrandBlue7;
...
function hr(o, e) {
  var i, d, g, p, h, A, I, E, F, R, j, W, $, z, N, _, V, Y, w;
  if (e == null)
    return {
      text: "",
...
const $r = 5;
function zr(o, e = {}) {
  const t = e.maxDepth ?? $r, n = [], c = /* @__PURE__ */ new Set();
  let u = o, s = 0;
  for (; u != null && s < t; ) {
...
function P(o, e) {
  ...
  return e != null && Lr(t, e), K(t.showHidden) && (t.showHidden = !1), K(t.depth) && (t.depth = 2), K(t.colors) && (t.colors = !0), K(t.customInspect) && (t.customInspect = !0), t.colors && (t.stylize = Vr), q(t, o, t.depth);
}
P.colors = lr;
P.styles = {
  special: "cyan",
...
`, `
  ...
  o.seen.push(e);
  let g;
  return i ? g = Ur(o, e, t, u, c) : g = c.map((p) => sr(o, e, t, u, p, i)), o.seen.pop(), Jr(g, s, d);
}
function sr(o, e, t, n, c, u) {
  ...
  if (d.get ? d.set ? i = o.stylize("[Getter/Setter]", "special") : i = o.stylize("[Getter]", "special") : d.set && (i = o.stylize("[Setter]", "special")), Gr(n, c) || (s = "[" + c + "]"), i || (o.seen.indexOf(d.value) < 0 ? (br(t) ? i = q(o, d.value, void 0) : i = q(o, d.value, t - 1), i.indexOf(`
`) > -1 && (u ? i = i.split(`
`).map((g) => "  " + g).join(`
`).substr(2) : i = `
` + i.split(`
...
function qr() {
  ...
  const u = {
    ...
    getCallerStackFrame(a, l = new Error()) {
      ...
      if (B.length === 0)
        return {};
      const f = jr(B, n), k = Number.isFinite(a) && a >= 0, y = gr(k ? a : f, B.length);
      return B[y] ?? {};
    },
    getErrorTrace(a) {
      return or(a, (l) => s(l));
    ...
    prettyFormatErrorObj(a, l) {
      const B = g(u.getErrorTrace(a), l), f = zr(a).map((y, G) => {
...
`), L = A(a), D = y ? a : L;
  ...
  function h(a) {
    return a && (o.name === "browser" || o.name === "worker") && Zr();
  }
  function A(a) {
    return a.replace(re, "");
  }
  function I(a, l) {
    ...
    for (; (D = L.exec(B)) != null; ) {
      ...
      const S = D[1], m = f[S] != null ? String(f[S]) : "", M = E((b = a.prettyLogStyles) == null ? void 0 : b[S], m), O = F(M);
  ...
  function j() {
    return c === void 0 && (c = Xr() ?? null), c ?? void 0;
  }
  function W() {
...
}, te = /(?:(?:file|https?|global code|[^@]+)@)?(?:file:)?((?:\/[^:/]+){2,})(?::(\d+))?(?::(\d+))?/, C = qr();
class ne {
...
{{errorStack}}`,
  ...
  log(e, t, ...n) {
    var I, E, F, R, j, W, $, z, N, _, V, Y;
    if (e < this.settings.minLevel)
      return;
    const c = this._resolveLogArguments(n), u = [...this.settings.prefix, ...c], s = ((I = this.settings.overwrite) == null ? void 0 : I.mask) != null ? (E = this.settings.overwrite) == null ? void 0 : E.mask(u) : this.settings.maskValuesOfKeys != null && this.settings.maskValuesOfKeys.length > 0 ? this._mask(u) : u, i = this.logObj != null ? this._recursiveCloneAndExecuteFunctions(this.logObj) : void 0, d = ((F = this.settings.overwrite) == null ? void 0 : F.toLogObj) != null ? (R = this.settings.overwrite) == null ? void 0 : R.toLogObj(s, i) : this._toLogObj(s, i), g = ((j = this.settings.overwrite) == null ? void 0 : j.addMeta) != null ? (W = this.settings.overwrite) == null ? void 0 : W.addMeta(d, e, t) : this._addMetaToLogObj(d, e, t), p = g == null ? void 0 : g[this.settings.metaProperty];
    let h, A;
...
function fe(o) {
  const e = le(), t = new ce(e, o), n = new ae({
    minLevel: 0,
...
//# sourceMappingURL=logger-CC_FxqwC.js.map
