...
function N(n, t) {
  ...
  const o = i.map(
    (a) => a.replace(/\{\{|\}\}/g, "")
  ), c = [...new Set(o)], b = t.variables, p = c.map((a) => b.find((w) => w.key === a) || {
    key: a,
...
const F = async (n, t) => t.entity ? s(n, t.entity) != null : !0, s = async (n, t) => {
  const [e, r] = t.split(".");
  if (!e || !r)
    return;
...
}, V = "extension/agent-editor", A = "agenteditor.agent", d = "agenteditor.model";
class G {
  async loaded(t) {
    const e = C(t);
    try {
...
//# sourceMappingURL=index-B3zwWrOT.js.map
