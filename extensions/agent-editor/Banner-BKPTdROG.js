import { w as r, x as c, aL as s, y as i, T as w, a2 as p, aS as f } from "./Icon-DlQJfq7F.js";
import { r as g } from "./DesignSystemTokens-BZrmEyPo.js";
...
const V = T((e) => r.jsx(c, { light: R, dark: E, ...e }), "CheckmarkIcon"), N = i.div`
    [role="alert"] {
        align-items: start;
        padding: 8px 8px;
        & > button {
...
`, l = ({ children: e, type: t, icon: o, onClose: n }) => /* @__PURE__ */ r.jsx(N, { children: /* @__PURE__ */ r.jsx(O, { type: t, icon: o, onClose: n, children: e }) }), z = (e) => /* @__PURE__ */ r.jsx(l, { ...e, type: "info", icon: /* @__PURE__ */ r.jsx(f, {}) }), J = (e) => /* @__PURE__ */ r.jsx(l, { ...e, type: "warning", icon: /* @__PURE__ */ r.jsx(W, {}) }), K = (e) => /* @__PURE__ */ r.jsx(l, { ...e, type: "success", icon: /* @__PURE__ */ r.jsx(V, {}) });
export {
  z as I,
  K as S,
  J as W
};
//# sourceMappingURL=Banner-BKPTdROG.js.map
