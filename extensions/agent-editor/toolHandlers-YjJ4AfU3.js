import { y as x, r as u, w as s, J as k, K as $, S as E } from "./TextInputWithIcon-DVt8kRsz.js";
import { T as C } from "./TextAreaAutogrow-od8_jgL4.js";
import { g as R, C as v } from "./genAICommonsEntities-DKB9GYxl.js";
const z = x(C).withConfig({
...
`, L = ({
  ...
  const p = u.useRef(null), l = u.useRef(null), [j, D] = u.useState(0), S = d || 5, b = m && m.length > 0, A = () => {
    ...
    const t = [];
    m.forEach((o, T) => {
      Array.from(a.matchAll(o.pattern)).forEach((h) => {
    ...
    return t.forEach((o, T) => {
      o.start > r && n.push(
        /* @__PURE__ */ s.jsx("span", { children: a.slice(r, o.start) }, `text-${r}-${o.start}`)
      ), o.start >= r && (n.push(
        /* @__PURE__ */ s.jsx("span", { style: o.style, children: o.text }, `placeholder-${o.ruleIndex}-${T}`)
      ), r = o.end);
    }), r < a.length && n.push(/* @__PURE__ */ s.jsx("span", { children: a.slice(r) }, `text-${r}-end`)), n;
  }, w = u.useCallback(() => {
    var n;
  ...
  return u.useEffect(() => {
    ...
    i && /* @__PURE__ */ s.jsx($, { children: /* @__PURE__ */ s.jsx(E, { children: i }) }),
  ...
  const c = await i.ui.elementSelectors.selectDocument({
    query: { elementType: f }
  });
  return c.status === "ok" ? {
    ...e,
    [a]: c.selected.module + "." + c.selected.name
  } : null;
}, H = async (i, e, a, f) => {
  const c = f.tools;
  switch (i) {
...
//# sourceMappingURL=toolHandlers-YjJ4AfU3.js.map
