  ...
  switch (e) {
    case "name":
      ...
      if (s && s.some((r) => r.name === t.name))
        return "Tool name must be unique. It is already used for a Knowledge base for this agent, please choose a different name.";
      break;
    case "description": {
      if (!t.toolType || t.toolType === y.MCP)
        break;
...
//# sourceMappingURL=toolHandlers-BZWxMr_G.js.map
