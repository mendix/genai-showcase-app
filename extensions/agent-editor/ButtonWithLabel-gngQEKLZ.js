import { y as g, w as n, x as h, r as p, F as u, H as c, T as f, S as v } from "./Icon-DlQJfq7F.js";
import { S as m, I as j } from "./ComboBox-Dckpz5IF.js";
import { T as k } from "./TextWithIcon-sxhIisHZ.js";
import { f as y, i as B, j as w, k as b } from "./modelUtils-whA8-BBg.js";
const C = g.div`
    & [role="combobox"] {
        ${(e) => e.iconurl && `
...
const q = E((e) => n.jsx(h, { light: D, dark: V, ...e }), "ConstantIcon"), s = {
  ...
  if (!a)
    return s.Required;
  const r = await y(e, a.documentId);
  if (!r)
    return s.NotFound;
  if (r.excluded)
    return s.Excluded;
...
//# sourceMappingURL=ButtonWithLabel-gngQEKLZ.js.map
