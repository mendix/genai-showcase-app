...
import { S as v, r as d } from "./PageContainers-BqHFWUr4.js";
import { D as z, a as j, d as W, c as q } from "./formelements-DRgD5gZX.js";
import { b as x, v as D, e as M } from "./toolUtils-6Ez2eFCF.js";
const P = v.div`
    position: absolute;
    top: 0;
    left: 0;
...
`, K = ({
  ...
  const h = d.useRef(null), b = d.useRef(null), [A, E] = d.useState(0), C = l || 5, T = y && y.length > 0, $ = () => {
    if (!T) return null;
    const t = [];
    y.forEach((r, f) => {
    ...
    if (t && b.current) {
      const a = t.scrollTop;
      b.current.style.setProperty("--scroll-offset", `-${a}px`);
    }
  }, []);
  return d.useEffect(() => {
    const t = h.current?.querySelector("textarea");
  ...
  }, [g, w]), /* @__PURE__ */ n.jsxs(z, { children: [
    c && /* @__PURE__ */ n.jsx(j, { children: /* @__PURE__ */ n.jsx(W, { children: c }) }),
    /* @__PURE__ */ n.jsx(j, { fullWidth: !0, children: /* @__PURE__ */ n.jsxs(R, { ref: h, children: [
      T && /* @__PURE__ */ n.jsxs(n.Fragment, { children: [
        /* @__PURE__ */ n.jsx(I, {}),
        /* @__PURE__ */ n.jsx(P, { ref: b, style: { paddingRight: `${2 + A}px` }, children: $() })
      ] }),
      /* @__PURE__ */ n.jsx(
        q,
        {
