import { r as c, T as a, U as i, R as r, bp as u, bS as g, bT as f, S as x, bU as h, a8 as n } from "./formelements-DgWWXRMR.js";
function O(t, e) {
  c.useEffect(() => {
...
const b = l(({ children: t, ...e }) => r.jsx(u, { children: r.jsx(C, { children: r.jsx(k, { ...e, children: t }) }) }), "ButtonFooter"), C = l(({ children: t }) => {
...
const D = M(({ onPress: t }) => r.jsx(L, { showLabel: !1, onPress: t, children: r.jsx(P, {}) }), "HelpButton"), L = a(n)`
    ${h};
`, E = a(b)`
    margin-top: auto;
    padding: 16px 0 0 0;
