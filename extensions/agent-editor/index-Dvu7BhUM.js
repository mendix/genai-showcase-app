...
import { a as Me, b as ke, o as be, g as _e, M as u, r as Pe, s as xe, m as ve } from "./settings-Bgs47ll9.js";
import { k as P } from "./knowledgebaseIcons-B7aB_ZnQ.js";
import { n as O, m as D, k as y, l as C, K as L, o as Se, e as Be, f as Le, h as Ge, a as x } from "./documentInitUtils-COeMuvhV.js";
import { m as v } from "./toolIcons-B55yYne7.js";
import { E as qe, M as S, C as p, b as Ue } from "./studioPro-BAnarQ8w.js";
import { b as ze, T as Fe, f as Ke, i as Ye, j as Ve, k as Xe, g as je, C as He } from "./toolUtils-B-Rm60rY.js";
import { M as m } from "./model-BUBkL5rT.js";
import { U as Qe } from "./agent-D1oN8aFA.js";
import { g as G } from "./customBlobDocumentUtils-DRHCWWx0.js";
import { C as Je, a as We, i as h } from "./compatibilityUtils-Chr7KNop.js";
...
class $e {
  ...
  async updateAgentDependencies(e) {
    const n = await this.studioPro.app.model.customBlobDocuments.getDocumentsOfType(O);
    for (const t of n) {
      ...
      if ("document" in o && o.document) {
        if (o.document.contents.model && this.checkAndRenameDependency(o.document, o.document.contents.model, e, D), o.document.contents.entity && this.checkAndRenameDependency(
          ...
          for (const i of o.document.contents.tools) {
            const s = i.toolType === ze.Microflow ? S : y;
...
const q = "AE001", U = "AE002", z = "AE003", F = "AE004", K = "AE005", Y = "AE006", V = "AE007", X = "AE008", j = "AE009", H = "AE010", Q = "AE011", J = "AE012", W = "AE013", Z = "AE014", $ = "AE015", ee = "AE016", te = "AE017", oe = "AE018", ot = [
  q,
  U,
  z,
  F,
  ...
  te,
  oe
], g = "AE101", I = "AE102", w = "AE103", N = "AE104", ne = "AE105", re = "AE106", se = "AE107", ie = "AE108", M = "AE109", nt = [
  g,
  I,
  w,
  N,
  ...
  const n = await Oe(r, e);
  if (!n)
    return e.attributes.map((o) => o.name);
  const t = await Re(r, n);
...
async function lt(r, e) {
  ...
  const o = await Te(r, e.entity.qualifiedName);
  if (!o)
    return n.push({
      elementText: "Context entity",
      errorCode: Y,
  ...
  const i = await Re(r, o), s = e.variables.filter((a) => !i.includes(a.key)).map((a) => a.key);
...
const yt = (r) => ({
  check: async (e) => {
    const n = await Ct(r, e), t = await Rt(r, e);
    return {
...
const d = {
  ...
  check: async (e) => {
    ...
    return e.provider === L.MxCloudGenAI && (t = await Ot(r, e, n)), t;
  },
  reservedErrorCodes: st
});
async function Ot(r, e, n) {
  const t = [], o = [];
  if (!h(
    n,
...
const ht = (r) => ({
  check: async (e) => {
    const n = await r.app.model.modules.getModules();
    let t = { errors: [], dependentElementIds: [] };
    return e.provider === m.MxCloudGenAI ? t = await gt(r, e, n) : e.provider === m.Azure && (t = await It(r, e, n)), t;
  },
...
const he = "extension/agent-editor";
class wt {
  async loaded(e) {
    const n = Ne(e);
    try {
      if (await n.app.model.customBlobDocuments.registerDocumentType({
        ...
        defaultContent: Be(),
        consistencyCheckRegistration: ht(n),
        serializationCallback: async (t) => JSON.stringify(t, null, 2)
      }), await n.app.model.customBlobDocuments.registerDocumentType({
        type: y,
        ...
        defaultContent: Ge(),
        consistencyCheckRegistration: Tt(n),
        serializationCallback: async (t) => JSON.stringify(t, null, 2)
      }), e.runMode === "ui") {
        const { createStudioProLogger: t } = await import("./logger-gMbuSAUF.js"), { createAnalyticsService: o } = await import("./analytics-BNjX2JPD.js"), { createDocumentReferenceSyncService: i } = await import("./documentReferenceSync-CiIT37W9.js"), s = _(e), a = be(e), l = t(s), T = await _e(s), ge = o(a, T, l), Ie = i(s, l);
        tt(s, l).registerListeners(), ge.registerDocumentCreationListener(s), Ie.registerListeners();
        let b = !1;
