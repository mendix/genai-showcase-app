import { a as F, $ as w, c as k, b as m, M as H, N as M, O as V, r as h, j as y, s as D, q as E, t as L, u as j, w as P, x as T, y as B } from "./Icon-DlQJfq7F.js";
import { r as b } from "./DesignSystemTokens-BZrmEyPo.js";
function O(s, e) {
  ...
  return {
    ...
    linkProps: m(p, C, {
      ...
      onClick: (x) => {
        var u;
        (u = i.onClick) === null || u === void 0 || u.call(i, x), V(x, g, s.href, s.routerOptions);
      }
    })
  };
}
...
}), I = "data:image/svg+xml,%3csvg%20width='16'%20height='16'%20viewBox='0%200%2016%2016'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M13.5%202.5L7.5%208.5'%20stroke='%23579BF9'%20stroke-miterlimit='10'/%3e%3cpath%20d='M9%202.5H13.5V7'%20stroke='%23579BF9'%20stroke-miterlimit='10'/%3e%3cpath%20d='M12.5%209V13C12.5%2013.275%2012.275%2013.5%2012%2013.5H3C2.725%2013.5%202.5%2013.275%202.5%2013V4C2.5%203.725%202.725%203.5%203%203.5H7'%20stroke='%23579BF9'%20stroke-miterlimit='10'/%3e%3c/svg%3e", N = "data:image/svg+xml,%3csvg%20width='16'%20height='16'%20viewBox='0%200%2016%2016'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M13.5%202.5L7.5%208.5'%20stroke='%23146FF4'%20stroke-miterlimit='10'/%3e%3cpath%20d='M9%202.5H13.5V7'%20stroke='%23146FF4'%20stroke-miterlimit='10'/%3e%3cpath%20d='M12.5%209V13C12.5%2013.275%2012.275%2013.5%2012%2013.5H3C2.725%2013.5%202.5%2013.275%202.5%2013V4C2.5%203.725%202.725%203.5%203%203.5H7'%20stroke='%23146FF4'%20stroke-miterlimit='10'/%3e%3c/svg%3e";
var R = Object.defineProperty, _ = (s, e) => R(s, "name", { value: e, configurable: !0 });
const q = _((s) => P.jsx(T, { light: N, dark: I, ...s }), "ExternalLinkIcon");
var U = Object.defineProperty, A = (s, e) => U(s, "name", { value: e, configurable: !0 });
const Q = A(({ children: s, href: e, ...t }) => P.jsxs(G, { href: e, ...t, children: [s ?? e, e && P.jsx(q, {})] }), "Link"), G = B(z)`
...
//# sourceMappingURL=Link-DxInpxg1.js.map
