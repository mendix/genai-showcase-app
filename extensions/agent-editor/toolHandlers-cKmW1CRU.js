import { z as v, r as l, w as a, D as z, C as j, Q as $, F as q } from "./Icon-B4HLWuEl.js";
import { T as h, E as W, F as D } from "./index-foeQU_BV.js";
const M = v.div`
    position: absolute;
    top: 0;
    left: 0;
...
`, N = ({
  ...
  const x = l.useRef(null), y = l.useRef(null), [k, A] = l.useState(0), C = g || 5, T = m && m.length > 0, E = () => {
    if (!T) return null;
    const t = [];
    m.forEach((i, c) => {
  ...
  return l.useEffect(() => {
  ...
  }, [w, b]), /* @__PURE__ */ a.jsxs(z, { children: [
    ...
    /* @__PURE__ */ a.jsx(j, { fullWidth: !0, children: /* @__PURE__ */ a.jsxs(P, { ref: x, children: [
      T && /* @__PURE__ */ a.jsxs(a.Fragment, { children: [
        /* @__PURE__ */ a.jsx(R, {}),
        /* @__PURE__ */ a.jsx(M, { ref: y, style: { paddingRight: `${2 + k}px` }, children: E() })
      ] }),
      /* @__PURE__ */ a.jsx(
        q,
        {
...
//# sourceMappingURL=toolHandlers-cKmW1CRU.js.map
