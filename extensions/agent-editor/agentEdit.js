...
import { i as Je, g as ge, c as Ge, m as Xe, a as Qe, k as Ye, T as ne, b as et, d as tt, e as it, f as st, h as at, j as nt, l as J, n as ot, o as lt, u as dt } from "./index-DGdkDQEu.js";
...
import { T as le, h as mt } from "./toolHandlers-CgtSxuYg.js";
import { T as G } from "./TextInputWithButton-DdFsQTz_.js";
import { h as ht } from "./knowledgebaseToolHandlers-DLTtGDFA.js";
import { r as L } from "./DesignSystemTokens-BZrmEyPo.js";
import { u as be, T as ve, D as O } from "./Table-CfPTytSG.js";
function gt(e, t, n) {
  let { isDisabled: s = !1, isReadOnly: o = !1, value: c, name: r, form: h, children: g, "aria-label": i, "aria-labelledby": f, validationState: v = "valid", isInvalid: y, onPressStart: C, onPressEnd: $, onPressChange: k, onPress: l, onPressUp: d, onClick: b } = e, j = (I) => {
  ...
  let { pressProps: R, isPressed: A } = Q({
    ...
    onPress(I) {
      var D;
      l == null || l(I), t.toggle(), (D = n.current) === null || D === void 0 || D.focus();
    },
    isDisabled: s || o
...
function pe(e, t, n) {
  let s = ue({
    ...e,
    value: t.isSelected
  }), { isInvalid: o, validationErrors: c, validationDetails: r } = s.displayValidation, { labelProps: h, inputProps: g, isSelected: i, isPressed: f, isDisabled: v, isReadOnly: y } = gt({
    ...e,
    isInvalid: o
  }, t, n);
  Ee(e, s, n);
  let { isIndeterminate: C, isRequired: $, validationBehavior: k = "aria" } = e;
  u.useEffect(() => {
...
function we(e = {}) {
  let { isReadOnly: t } = e, [n, s] = Me(e.isSelected, e.defaultSelected || !1, e.onChange), [o] = u.useState(n);
  function c(g) {
    t || s(g);
  }
  function r() {
...
function vt(e, t, n) {
  ...
  let { name: o, form: c, descriptionId: r, errorMessageId: h, validationBehavior: g } = bt.get(t);
  var i;
  ...
  u.useEffect(y);
  let C = t.realtimeValidation.isInvalid ? t.realtimeValidation : f, $ = g === "native" ? t.displayValidation : C;
  var k;
  let l = pe({
    ...e,
    isReadOnly: e.isReadOnly || t.isReadOnly,
...
const pt = /* @__PURE__ */ u.createContext(null), wt = /* @__PURE__ */ u.forwardRef(function(t, n) {
  ...
  let g = (h = (r = t.validationBehavior) !== null && r !== void 0 ? r : c) !== null && h !== void 0 ? h : "native", i = u.useContext(pt), f = Re(u.useMemo(() => De(s, t.inputRef !== void 0 ? t.inputRef : null), [
    s,
    t.inputRef
  ])), { labelProps: v, inputProps: y, isSelected: C, isDisabled: $, isReadOnly: k, isPressed: l, isInvalid: d } = i ? vt({
    ...se(t),
    ...
    children: typeof t.children == "function" ? !0 : t.children,
    validationBehavior: g
  }, we(t), f), { isFocused: b, isFocusVisible: j, focusProps: S } = He(), E = $ || k, { hoverProps: R, isHovered: A } = Oe({
    ...t,
    isDisabled: E
  }), M = qe({
    ...t,
...
const Et = jt((e) => a.jsx(B, { light: St, dark: Tt, ...e }), "EntityNonPersistableIcon"), Mt = async (e, t, n, s, o, c) => {
  ...
  }), s.status === "none" && (o = { ...t, entity: void 0 }), o) {
  ...
  let o;
  return s.status === "ok" && (o = {
    ...t,
    model: {
      documentId: s.selected.id,
      qualifiedName: s.selected.module + "." + s.selected.name
    }
  }), s.status === "none" && (o = { ...t, model: void 0 }), o && n(o), o;
}, X = async (e, t, n) => {
  switch (e) {
    case "model": {
      if (!n.model)
    ...
    case "entity": {
      ...
      const [s, o] = n.entity.qualifiedName.split(".");
      if (!s || !o)
  ...
  let c;
  return o && (c = o), c && s(c), c;
}, de = async (e, t, n, s, o) => {
  const c = o && n.tools ? n.tools.find((h) => h.id === o) : void 0, r = await e.ui.dialogs.showModal(
    {
  ...
  if (r !== null) {
    const h = r;
    let g;
    o && n.tools ? g = n.tools.map((f) => f.id === o ? h : f) : g = [...n.tools || [], h], g.sort((f, v) => f.name.localeCompare(v.name));
    const i = { ...n, tools: g };
    return s(i), i;
  } else
    return null;
  ...
  const c = n.knowledgebaseTools || [], r = o ? c.find((g) => g.id === o) : void 0, h = await e.ui.dialogs.showModal(
    {
  ...
  if (h !== null) {
    const g = h;
    let i;
    o ? i = c.map((v) => v.id === o ? g : v) : i = [...c, g], i.sort((v, y) => v.name.localeCompare(y.name));
...
`, ri = ({
  ...
  const [r, h] = u.useState([]), g = u.useMemo(() => (e.knowledgebaseTools || []).map((d, b) => ({
    ...
    (l) => {
      const d = c.get(l);
      return d === "invalid" ? /* @__PURE__ */ a.jsx(K, { icon: /* @__PURE__ */ a.jsx(me, { title: "Tool invalid" }) }) : d === "syncing" ? /* @__PURE__ */ a.jsx(K, { icon: /* @__PURE__ */ a.jsx(Ce, { title: "Validating..." }) }) : null;
    },
    [c]
    ...
    l && o(l);
  }, [t, n, e, s, o]), C = u.useCallback(async () => {
    ...
    b && o(b);
  }, [t, n, e, s, o, r]), $ = u.useCallback(async () => {
    const l = e.knowledgebaseTools || [];
    if (r.length === 0 || l.length === 0)
      return;
    ...
    b && o(b);
  }, [e, s, o, r]), k = u.useCallback(
    async (l, d) => {
      const b = e.knowledgebaseTools || [];
      if (b.length === 0)
        return;
      const j = b.map(
        (E) => (E.id ?? "") === l ? { ...E, enabled: d } : E
      ), S = { ...e, knowledgebaseTools: j };
      s(S), o(S);
    },
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [e.knowledgebaseTools, s, o]
  );
  return /* @__PURE__ */ a.jsx(N, { label: "Knowledge bases", children: /* @__PURE__ */ a.jsx(
    ve,
    {
      ...
      data: i.map((l) => [
        ...
        l.name,
        l.description,
        /* @__PURE__ */ a.jsx(he, { icon: Ye, text: l.tool })
      ]),
      rowKey: (l, d) => {
        var b;
...
`, ui = ({
  ...
  const [r, h] = u.useState([]), g = u.useMemo(() => e.tools ? e.tools.map((l, d) => ({
    id: l.id ?? String(d),
    enabled: l.enabled,
    ...
    if (r.length === 0 || !e.tools)
      return;
    const l = r[0], d = await Bt(t, e, s, l);
    d && o(d);
  }, [e, s, o, r]), k = u.useCallback(
    async (l, d) => {
      if (!e.tools)
    ...
    ve,
    {
      ...
      data: i.map((l) => [
        ...
        /* @__PURE__ */ a.jsx(
          he,
          {
            icon: l.tooltype === ne.Microflow ? /* @__PURE__ */ a.jsx(rt, {}) : et,
            text: l.tool
          }
        )
      ]),
  ...
  var ee, te, ie;
  const [s, o] = u.useState(!1), [c, r] = u.useState(fi), [h, g] = u.useState(void 0), [i, f] = u.useState(e), [v, y] = u.useState(!1), [C, $] = u.useState(!1), [k, l] = u.useState(/* @__PURE__ */ new Map()), [d, b] = u.useState(
    /* @__PURE__ */ new Map()
  ), j = _e(), S = u.useRef(null);
  u.useEffect(() => {
    var m;
    Y(e).then((x) => r(x)), D(t, (m = e.entity) == null ? void 0 : m.qualifiedName).then((x) => g(x)), f(e), o(!0);
  }, []), u.useEffect(() => {
    s && f(e);
  }, [e]), u.useEffect(() => () => {
  ...
  return /* @__PURE__ */ a.jsxs(a.Fragment, { children: [
    ...
    /* @__PURE__ */ a.jsx(ae, { children: /* @__PURE__ */ a.jsxs(N, { label: "General", children: [
      ...
      c.showCreateVariablesInfo && c.unusedAttributes.length === 0 && !C && /* @__PURE__ */ a.jsx(oe, { onClose: () => $(!0), children: "Create variables: Enclose a word or text in double curly brackets. For example, you can write {{Language}} in the system or user prompt." }),
  ...
  const n = e.ui.messageBoxes, s = e.app.model.customBlobDocuments, [o, c] = u.useState(!1), [r, h] = u.useState(hi), [g, i] = u.useState(0);
  return u.useEffect(() => {
    const f = (v) => {
    ...
    !o && /* @__PURE__ */ a.jsx(Ze, {}),
    o && /* @__PURE__ */ a.jsx(We, { children: /* @__PURE__ */ a.jsx(
      mi,
      {
        loadedAgent: r,
        studioPro: e,
