  ...
  switch (console.log("HandleValidate triggered with field", e), e) {
    case "modelQualifiedName":
      if (!i.modelQualifiedName)
        return console.log("no model name found"), "Please select a model.";
      if (!(await t.app.model.customBlobDocuments.getDocumentsOfType(re)).find((v) => v.moduleName + "." + v.name === i.modelQualifiedName))
        return console.log("Invalid document type selected for Model"), "This document is invalid. Make sure to select a document of type Model.";
      break;
    case "entity":
      if (i.variables.length > 0 && !i.entity)
        return "Please select an entity.";
      const [o, d] = i.entity.split(".");
      if (!o || !d)
    ...
    case "userPrompt":
      if (!i.userPrompt)
        return console.log("no user prompt found"), "Please provide a user prompt.";
      break;
    default:
      return !0;
  }
...
`, R = ({
  ...
  return l.useEffect(() => {
    ...
    if (m) {
      ...
      return p.observe(m), m.addEventListener("scroll", A), () => {
        p.disconnect(), m.removeEventListener("scroll", A);
      };
    }
  ...
  const h = v ? 8 : 0;
  return /* @__PURE__ */ n.jsxs(N, { marginTop: h, children: [
    e && /* @__PURE__ */ n.jsx(L, { children: /* @__PURE__ */ n.jsx(z, { children: e }) }),
    /* @__PURE__ */ n.jsx(L, { fullWidth: !0, children: /* @__PURE__ */ n.jsxs(N, { children: [
      /* @__PURE__ */ n.jsx(L, { fullWidth: !0, children: /* @__PURE__ */ n.jsx(
        X,
        {
          ariaLabel: t,
          value: i,
  ...
  entityInput: !0,
  userPromptInput: !0,
  showEntityNotFound: !1,
  showCreateVariables: !1,
  missingAttributes: [],
  unusedAttributes: []
  ...
  l.useEffect(() => {
    c.getDocumentById(t).then(async (s) => {
      ...
      i.show("error", "Error loading document", "Details: " + (s == null ? void 0 : s.message) || s);
    });
  }, []), l.useEffect(() => {
    d && (async () => {
      if (!a.entity) {
  ...
  l.useCallback(
    (s) => async (u) => {
      const C = await je(e, s, a, t)(u);
      h(C);
    },
    [e, a, h, t]
  ), l.useCallback(
    (s) => async (u) => {
      const C = await S(e, s, a, t)(u);
      h(C);
    },
    [e, a, h, t]
  );
  const j = l.useCallback((s) => {
    V(s), p.current && clearTimeout(p.current), p.current = setTimeout(async () => {
      const u = await S(e, "systemPrompt", a, t)(s);
      h(u);
    }, 300);
  }, [e, a, t]), G = l.useCallback((s) => {
    A(s), g.current && clearTimeout(g.current), g.current = setTimeout(async () => {
      const u = await S(e, "userPrompt", a, t)(s);
      h(u);
    }, 300);
  ...
  }, [e, a, t]), Y = l.useCallback(
    async () => {
      const s = await Ae(e, a, t);
      s && h(s);
    },
    [e, a, h, t]
  ), J = l.useCallback(
    async () => {
      const s = await ke(e, a, t, "modelQualifiedName");
      s && h(s);
    },
    [e, a, h, t]
  );
  l.useCallback(
    async (s, u) => {
      const C = await Ee(e, a, t)(s, u);
      h(C);
    },
    [e, a, h, t]
  );
  const K = async (s) => ({
    modelInput: await F("modelQualifiedName", e, s),
    entityInput: await F("entity", e, s),
    userPromptInput: await F("userPrompt", e, s),
    showEntityNotFound: await q(e, s) === !1,
    showCreateVariables: s.variables.length === 0,
    missingAttributes: await de(e, s),
    unusedAttributes: await ue(e, s)
  });
  return /* @__PURE__ */ n.jsx(ee, { studioPro: e, children: /* @__PURE__ */ n.jsxs(te, { children: [
    !d && /* @__PURE__ */ n.jsx("span", { children: "Loading document content..." }),
    d && /* @__PURE__ */ n.jsxs(ne, { children: [
      /* @__PURE__ */ n.jsxs($, { children: [
        ...
        /* @__PURE__ */ n.jsx(B, { label: "User prompt", children: /* @__PURE__ */ n.jsx(
          R,
          {
            ...
            onChange: G,
            highlightRules: H,
            validate: () => r.userPromptInput
          }
        ) })
      ] }),
      /* @__PURE__ */ n.jsx($, { children: /* @__PURE__ */ n.jsxs(B, { label: "General", children: [
        /* @__PURE__ */ n.jsx(
          O,
          {
            ariaLabel: "Model",
            ...
            icon: a.modelQualifiedName ? pe : void 0,
            buttonCaption: "Select...",
            onClick: J,
            validate: () => r.modelInput
          }
        ),
        /* @__PURE__ */ n.jsx(
          U,
        ...
        /* @__PURE__ */ n.jsx(
          O,
          {
            ...
            onClick: Y,
            buttonCaption: "Select...",
            validate: () => r.entityInput
          }
        ),
        r.showEntityNotFound && /* @__PURE__ */ n.jsx(se, { children: `Entity with name ${a.entity} does not exist (anymore). Please select a valid entity.` }),
        r.showCreateVariables && /* @__PURE__ */ n.jsx(I, { children: "Create variables: Enclose a word or text in double curly brackets. For example, you can write {{Language}} in the system or user prompt." }),
        r.missingAttributes.length > 0 && /* @__PURE__ */ n.jsxs(ae, { children: [
          /* @__PURE__ */ n.jsx("span", { children: "The following attributes cannot be found on the selected entity:" }),
          /* @__PURE__ */ n.jsx("ul", { children: r.missingAttributes.map((s) => /* @__PURE__ */ n.jsx("li", { children: s }, s)) })
        ] }),
        r.unusedAttributes.length > 0 && D && /* @__PURE__ */ n.jsxs(
          I,
          {
            onClose: () => M(!1),
            children: [
              /* @__PURE__ */ n.jsx("span", { children: "The following attributes are found on the selected entity, but are not used in the prompt:" }),
              /* @__PURE__ */ n.jsx("ul", { children: r.unusedAttributes.map((s) => /* @__PURE__ */ n.jsx("li", { children: s }, s)) })
            ]
          }
        )
      ] }) })
