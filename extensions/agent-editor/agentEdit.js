...
`, ui = ({
  ...
  return u.useEffect(() => {
    console.log("Setting up documentsChanged event listener for documentId", t);
    const f = (v) => {
      v.documents.some((y) => y.documentId === t) && (console.log("Document changed for documentId", t), i((y) => y + 1));
    };
