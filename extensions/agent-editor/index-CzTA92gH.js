...
import { d as Re, e as he, o as ge, g as Oe, f as I, M as u, r as we, s as Ne, h as Ie } from "./modelIcons-B8x4nF9U.js";
  ...
  async loaded(e) {
    ...
    try {
      if (await t.app.model.customBlobDocuments.registerDocumentType({
        ...
        const { createStudioProLogger: n } = await import("./logger-gMbuSAUF.js"), { createAnalyticsService: o } = await import("./analytics-DSd6ibhT.js"), { createDocumentReferenceSyncService: s } = await import("./documentReferenceSync-LSvj_LnO.js"), i = N(e), a = ge(e), d = n(i), l = await Oe(i), De = o(a, l, d), ye = s(i, d);
