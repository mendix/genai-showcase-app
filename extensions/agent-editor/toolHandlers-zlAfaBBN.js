import { ad as T, r as h, ae as r, aC as C, aD as y, aE as A, aM as R, aG as D, ag as F } from "./TextInputWithIcon-D0NqO6mp.js";
import { T as I } from "./ComboBox-C9jdqDSd.js";
...
`, N = ({
  ...
  const u = h.useRef(null), p = h.useRef(null), [g, b] = h.useState(0), S = a || 5, v = m && m.length > 0, E = () => {
    if (!v) return null;
    const n = [];
    m.forEach((c, x) => {
    ...
    }), s < o.length && l.push(/* @__PURE__ */ r.jsx("span", { children: o.slice(s) }, `text-${s}-end`)), l;
  }, j = h.useCallback(() => {
    var l;
    const n = (l = u.current) == null ? void 0 : l.querySelector("textarea");
    if (n) {
    ...
    if (n && p.current) {
      const s = n.scrollTop;
      p.current.style.setProperty("--scroll-offset", `-${s}px`);
    }
  }, []);
  return h.useEffect(() => {
    var l;
    ...
    /* @__PURE__ */ r.jsx(y, { fullWidth: !0, children: /* @__PURE__ */ r.jsxs(q, { ref: u, children: [
      v && /* @__PURE__ */ r.jsxs(r.Fragment, { children: [
        /* @__PURE__ */ r.jsx(z, {}),
        /* @__PURE__ */ r.jsx(O, { ref: p, style: { paddingRight: `${2 + g}px` }, children: E() })
      ] }),
      /* @__PURE__ */ r.jsx(
        W,
        {
  ...
  return /* @__PURE__ */ r.jsxs(C, { marginTop: b, children: [
    ...
    /* @__PURE__ */ r.jsx(y, { fullWidth: !0, children: /* @__PURE__ */ r.jsxs(C, { children: [
      ...
      /* @__PURE__ */ r.jsx(D, { onPress: i, children: d }),
      a && /* @__PURE__ */ r.jsx(D, { onPress: m, children: a })
    ] }) })
  ] });
...
const Y = Z((t) => r.jsx(F, { light: L, dark: B, ...t }), "MicroflowIcon"), J = async (t, e) => {
  ...
  if (!o || !d)
    return null;
  const i = await t.app.model.microflows.loadAll(
    (a) => a.moduleName === o && a.name === d
  );
  ...
  return i.status === "ok" ? {
    ...e,
    [o]: i.selected.module + "." + i.selected.name
  } : null;
}, Q = async (t, e, o, d) => {
  const i = d.tools;
  switch (t) {
    ...
    case "microflow": {
      ...
      const u = f.objectCollection.objects;
      if (u) {
        for (const p of u)
          if (p.$Type === "Microflows$MicroflowParameterObject") {
            if (a.includes(p.variableType.$Type))
              continue;
            if (p.variableType.$Type === "DataTypes$ObjectType" && m.includes(p.variableType.entity))
              continue;
            return `Tool microflow parameter "${p.name}" has an unsupported type. Only primitive types and GenAICommons.Request or GenAICommons.Tool objects are allowed.`;
          }
      }
      break;
    }
...
//# sourceMappingURL=toolHandlers-zlAfaBBN.js.map
