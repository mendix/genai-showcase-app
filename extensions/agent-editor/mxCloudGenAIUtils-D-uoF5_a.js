import { a as F, $ as A, c as h, b as y, V as D, j as M, W as I, r as x, n as V, w as B, v as H, x as j, y as N, D as $, E as U, F as G } from "./Icon-Cg7sFTxA.js";
import { r as k, c as f } from "./DesignSystemTokens-D4VnXWxy.js";
import { g as b, d as L } from "./modelUtils-BJFWOaUG.js";
function K(e, r) {
...
const S = /* @__PURE__ */ x.createContext(null), O = /* @__PURE__ */ x.forwardRef(function(r, s) {
  [r, s] = V(r, s, S);
  let t = r.href && !r.isDisabled ? "a" : "span", { linkProps: o, isPressed: n } = K({
    ...r,
    elementType: t
  }, s), { hoverProps: i, isHovered: a } = B(r), { focusProps: c, isFocused: d, isFocusVisible: l } = H(), u = j({
    ...r,
...
const W = q((e) => $.jsx(U, { light: z, dark: J, ...e }), "ExternalLinkIcon");
var Q = Object.defineProperty, R = (e, r) => Q(e, "name", { value: r, configurable: !0 });
const se = R(({ children: e, href: r, ...s }) => $.jsxs(X, { href: r, ...s, children: [e ?? r, r && $.jsx(W, {})] }), "Link"), X = G(O)`
...
//# sourceMappingURL=mxCloudGenAIUtils-D-uoF5_a.js.map
