...
const T = "data:image/png;base64,", R = "data:image/png;base64,", w = "data:image/png;base64,", b = "AE001", I = "AE002", M = "AE003", v = "AE004", B = "AE005", _ = "AE006", k = "AE007", x = "AE008", N = "AE009", F = "AE010", L = "AE011", S = "AE012", K = "AE013", Ee = [
  ...
  S,
  K
], P = "AE101", U = "AE102", q = "AE103", G = "AE104", pe = [
  P,
  U,
  q,
  G
], V = "AE201", z = "AE202", Y = "AE203", Q = "AE204", H = "AE205", X = "AE206", j = "AE207", J = "AE208", fe = [
  V,
  z,
  Y,
  Q,
  ...
  if (!t)
    return;
  const e = (r = await c(o, t)) == null ? void 0 : r.getContainer();
  if (!e) {
  ...
  Microflow: "Microflow",
  MCP: "MCP"
}, De = ["v2025_03_26", "v2024_11_05"], ge = De[0], st = async (o, t) => {
  const e = await m(o, t);
  if (!e)
...
}, he = (o) => "microflowActionInfo" in o, Oe = (o) => ({
  check: async (t) => {
    const e = await be(o, t), r = await Ie(o, t), n = Me(t), s = await ve(o, t), i = await Be(o, t);
    return {
      errors: [
        ...e.errors,
        ...r.errors,
...
async function Ie(o, t) {
  ...
  const n = await c(o, t.entity.qualifiedName), s = t.variables.filter((i) => !i.isAttributeInEntity).map((i) => i.key);
...
async function ve(o, t) {
  ...
  for (const n of t.tools) {
    ...
    const s = await Re(o, n.toolType, n.document), i = we(n.toolType);
    if (!s)
      e.push({
        elementText: "Tools",
        errorCode: x,
...
const ke = (o) => ({
  check: async (t) => {
    const e = await xe(o, t), r = await Ne(o, t);
    return {
...
async function Ne(o, t) {
  ...
  return n ? n.excluded ? (e.push({
    ...
    severity: "error",
    elementText: "Authentication microflow"
  }), (n.microflowReturnType.$Type !== "DataTypes$ListType" || n.microflowReturnType.entity !== E.HttpHeader) && e.push({
    errorCode: X,
...
const ze = async (o, t) => t.entity ? await c(o, t.entity.qualifiedName) !== void 0 : !0, mt = async (o, t) => t.variables.length === 0 ? [] : !t.entity || !await c(o, t.entity.qualifiedName) ? [] : t.variables.filter((e) => !e.isAttributeInEntity).map((e) => e.key), re = async (o, t) => {
  if (!o.entity)
    return [];
  const e = await c(t, o.entity.qualifiedName);
  return e ? (await te(t, e)).sort() : [];
}, At = async (o, t) => (await re(t, o)).filter((r) => !t.variables.find((n) => n.key === r));
function Ye() {
  return {
    protocolVersion: ge
  };
...
async function Qe(o, t) {
  try {
    o.app.projectChanges.addEventListener("elementsRenamed", async ({ elements: e }) => {
      await je(o, e), await Je(o, e), await We(o, e);
    });
  } catch (e) {
...
async function je(o, t) {
  ...
  for (const r of e) {
    ...
    if ("document" in n && n.document && (n.document.contents.model && d(o, n.document, n.document.contents.model, t), n.document.contents.entity && d(o, n.document, n.document.contents.entity, t), n.document.contents.tools))
      for (const s of n.document.contents.tools)
        d(o, n.document, s.document, t);
  }
}
async function Je(o, t) {
...
async function We(o, t) {
  ...
  for (const r of e) {
    const n = await o.app.model.customBlobDocuments.getDocumentById(r.id);
    "document" in n && n.document && n.document.contents.endpoint && d(o, n.document, n.document.contents.endpoint, t);
  }
}
const pt = "extension/agent-editor", p = "agenteditor.agent", f = "agenteditor.model", y = "agenteditor.consumedMCPService", h = "agenteditor.knowledgebase";
class $e {
  async loaded(t) {
    const e = ue(t), r = O(e);
    try {
      Qe(e, r), await e.app.model.customBlobDocuments.registerDocumentType({
        ...
        defaultContent: qe(),
        consistencyCheckRegistration: Oe(e)
...
//# sourceMappingURL=index-DEchU29s.js.map
