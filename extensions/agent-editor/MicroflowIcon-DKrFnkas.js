import { F as d, a1 as h, D as t, a2 as m, a3 as g, a4 as u, E as p } from "./Icon-Cg7sFTxA.js";
import { r as o } from "./DesignSystemTokens-D4VnXWxy.js";
var v = Object.defineProperty, f = (e, r) => v(e, "name", { value: r, configurable: !0 });
function $({ label: e, description: r, rows: i, cols: c, ...a }) {
  const { isInvalid: n, validationError: s, validate: l } = h(a);
  return t.jsx(m, { ...a, isInvalid: n, validate: l, children: t.jsx(g, { label: e, description: r, realtimeValidationError: s, children: t.jsx(b, { rows: i, cols: c }) }) });
}
f($, "TextArea");
const b = d(u)`
...
const M = C((e) => t.jsx(p, { light: w, dark: x, ...e }), "MicroflowIcon");
export {
  M as n,
  $ as y
};
//# sourceMappingURL=MicroflowIcon-DKrFnkas.js.map
