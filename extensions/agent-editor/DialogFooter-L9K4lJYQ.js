import { z as s, y as i, w as r, aw as p, be as x, r as g, bf as u, x as h, bg as f, T as n } from "./TextInputWithIcon-Cj_bxptw.js";
var m = Object.defineProperty, c = (t, e) => m(t, "name", { value: e, configurable: !0 });
const C = c(({ children: t, ...e }) => r.jsx(p, { children: r.jsx(v, { children: r.jsx(j, { ...e, children: t }) }) }), "ButtonFooter"), v = c(({ children: t }) => {
  const e = x(), a = g.useCallback((o) => {
    o.key === "ArrowLeft" && (e == null || e.focusPrevious({ wrap: !0 })), o.key === "ArrowRight" && (e == null || e.focusNext({ wrap: !0 }));
  }, [e]);
  return r.jsx(b, { role: "presentation", onKeyDownCapture: a, children: t });
}, "ButtonFocusWrapper"), w = s.div`
    flex-grow: 1;
`, b = s.div`
    display: contents;
`, j = s(u)`
...
var y = Object.defineProperty, F = (t, e) => y(t, "name", { value: e, configurable: !0 });
const P = F((t) => r.jsx(h, { light: k, dark: $, ...t }), "HelpIcon");
...
`, A = ({
  ...
  d && /* @__PURE__ */ r.jsx(D, { onPress: a }),
  /* @__PURE__ */ r.jsx(w, {}),
  /* @__PURE__ */ r.jsx(n, { variant: "primary", onPress: t, children: o }),
  /* @__PURE__ */ r.jsx(n, { onPress: e, children: l })
] });
export {
  A as D
};
//# sourceMappingURL=DialogFooter-L9K4lJYQ.js.map
