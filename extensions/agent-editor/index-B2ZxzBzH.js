...
const y = "data:image/png;base64,", f = "data:image/png;base64,", C = "data:image/png;base64,", M = "AE001", I = "AE002", b = "AE003", v = "AE004", x = "AE005", F = "AE006", B = "AE007", N = "AE008", _ = "AE009", k = "AE010", L = "AE011", ie = [
  ...
  k,
  L
], P = "AE101", S = "AE102", U = "AE103", V = "AE104", ae = [
  P,
  S,
  U,
  V
], G = "AE201", q = "AE202", z = "AE203", Q = "AE204", Y = "AE205", K = "AE206", H = "AE207", X = "AE208", ce = [
  G,
  q,
  z,
  Q,
  ...
  Microflow: "Microflow",
  MCP: "MCP"
}, le = ["v2025_03_26", "v2024_11_05"], ue = le[0], Ve = async (o, t) => {
...
}, pe = (o) => "microflowActionInfo" in o, ye = (o) => ({
  check: async (t) => {
    const e = await fe(o, t), n = await Ce(o, t), r = De(t), s = await Te(o, t);
    return {
...
async function Te(o, t) {
  ...
  for (const r of t.tools) {
    ...
    const s = await me(o, r.toolType, r.document.documentId), i = Ee(r.toolType);
    if (!s)
      e.push({
        elementText: "Tools",
        errorCode: N,
...
const we = (o) => ({
  check: async (t) => {
    const e = await Re(o, t), n = await he(o, t);
    return {
...
async function Re(o, t) {
  ...
  const r = await h(o, t.endpoint.documentId);
  return r ? r.excluded ? e.push({
    errorCode: Q,
...
async function Me(o, t) {
  ...
  const s = await h(o, r.key.documentId);
...
async function Ye(o, t, e) {
  const n = e.systemPrompt.match(/\{\{([^}]+)\}\}/g) || [], r = e.userPrompt ? e.userPrompt.match(/\{\{([^}]+)\}\}/g) || [] : [], s = t === ne, i = [...n, ...r];
  if (i.length === 0)
    return Promise.resolve([]);
  const A = i.map((d) => d.replace(/\{\{|\}\}/g, "")), Z = [...new Set(A)], ee = e.variables, te = Z.map((d) => ee.find((re) => re.key === d) || {
    key: d,
...
async function Fe(o, t, e) {
  const n = await Be(o, e), r = await $(e, o);
  return t.map((s) => {
...
const Be = async (o, t) => t.entity ? await c(o, t.entity.qualifiedName) !== void 0 : !0, He = async (o, t) => t.variables.length === 0 ? [] : !t.entity || !await c(o, t.entity.qualifiedName) ? [] : t.variables.filter((e) => !e.isAttributeInEntity).map((e) => e.key), $ = async (o, t) => {
  if (!o.entity)
    return [];
  const e = await c(t, o.entity.qualifiedName);
  return e ? (await j(t, e)).sort() : [];
}, Xe = async (o, t) => (await $(t, o)).filter((n) => !t.variables.find((r) => r.key === n));
function Ne() {
  return {
    protocolVersion: ue
  };
...
}, Je = "extension/agent-editor", D = "agenteditor.agent", T = "agenteditor.model", g = "agenteditor.consumedMCPService", w = "agenteditor.knowledgebase";
class _e {
  async loaded(t) {
    const e = se(t), n = R(e);
    try {
...
//# sourceMappingURL=index-B2ZxzBzH.js.map
