import { a as F, $ as w, c as k, b as P, ab as H, ac as V, ad as y, r as h, p as L, y as M, x as D, z as E, A as j, H as m, I as T, K as u, L as B } from "./Icon-UiLWY9J1.js";
function O(s, e) {
...
const K = A((s) => m.jsx(T, { light: R, dark: I, ...s }), "ExternalLinkIcon");
var N = Object.defineProperty, U = (s, e) => N(s, "name", { value: e, configurable: !0 });
const J = U(({ children: s, href: e, ...t }) => m.jsxs(q, { href: e, ...t, children: [s ?? e, e && m.jsx(K, {})] }), "Link"), q = B(z)`
