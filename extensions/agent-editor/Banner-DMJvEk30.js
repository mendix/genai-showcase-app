import { k as ee, j as te, e as W, b as I, bq as re, br as ne, bs as ae, r as z, x as ie, I as se, F as oe, E as le, G as ce, H as de, R as o, S, bg as A, T as y, U as v, a0 as ue, bt as fe, a8 as R, a3 as q } from "./formelements-xoDBPsLY.js";
function ge(e, t) {
  let { elementType: i = "a", onPress: c, onPressStart: g, onPressEnd: m, onClick: $, isDisabled: s, ...d } = e, l = {};
  i !== "a" && (l = {
    role: "link",
    tabIndex: s ? void 0 : 0
  });
  let { focusableProps: a } = ee(e, t), { pressProps: p, isPressed: h } = te({
    onPress: c,
    onPressStart: g,
    onPressEnd: m,
    onClick: $,
...
const he = /* @__PURE__ */ z.createContext(null), pe = /* @__PURE__ */ z.forwardRef(function(t, i) {
  [t, i] = ie(t, i, he);
  let c = t.href && !t.isDisabled ? "a" : "span", { linkProps: g, isPressed: m } = ge({
    ...t,
    elementType: c
  }, i), $ = se[c], { hoverProps: s, isHovered: d } = oe(t), { focusProps: l, isFocused: a, isFocusVisible: p } = le(), h = ce({
    ...t,
...
((e) => {
  function t(s) {
    if (!s) return "";
    const d = s.split("."), l = d.pop();
    if (!l) throw new Error(`Not a valid qualified name: "${s}"`);
    return d.length ? `${l} (${d.reverse().join(", ")})` : l;
  }
  e.beautifyQualifiedName = t, j(t, "beautifyQualifiedName");
  function i(s, d = "") {
    return s?.split(".").slice(-1)[0] ?? d;
  }
  e.getName = i, j(i, "getName");
  function c(s) {
    return s.split("$").slice(-1)[0];
  }
  e.getClassName = c, j(c, "getClassName");
  function g(s, d = !0) {
    function l(h) {
      return h >= "A" && h <= "Z";
    }
    ...
    for (let h = 1; h < s.length; h++) {
      const C = s.charAt(h - 1), b = s.charAt(h), L = s.charAt(h + 1);
      a(C) && l(b) ? p += ` ${d || l(L) ? b : b.toLowerCase()}` : l(C) && l(b) && a(L) ? p += ` ${d ? b : b.toLowerCase()}` : p += b;
    }
    return p;
  }
  e.deCamelCase = g, j(g, "deCamelCase");
  function m(s, d = !0, l = !0) {
    let a = s;
    return a = a.replace(/[^a-zA-Z0-9_ ]+/g, ""), a = a.replace(/[\s\xa0]+/g, " ").trim(), a = a.replace(/\W+/g, "_"), a.match(/^\d/) && (a = `_${a}`), d && M.validateNameSyntax(a) === "Name is a reserved word" && (a = `${a}_1`), l && M.validateNameSyntax(a) === "Name is too long" && (a = a.slice(0, M.DEFAULT_CHARACTER_LIMIT)), a;
  }
...
function D(e, t = !1, i) {
  try {
    ...
    return i && D(i) || `<circular structure>: ${D(c)}`;
  }
}
f(D, "safeStringify");
var Ee;
((e) => {
  ...
  e.collapseWhitespace = i, f(i, "collapseWhitespace");
  function c(r) {
    return r.replace(/\W/g, "_").toLowerCase();
  }
  e.sanitizeForClassName = c, f(c, "sanitizeForClassName");
  function g(r, n, u = " ") {
    let x = String(r);
    const w = n - x.length;
    let k = -1;
  ...
  function m(r) {
    return r.split(/\s+/).map((n, u) => J(n, u) ? $(n) : n).join(" ");
  }
  e.titleCase = m, f(m, "titleCase");
  function $(r, n = !0) {
    if (!r) return r;
    const u = n ? r.substring(1).toLocaleLowerCase() : r.substring(1);
    return r[0].toLocaleUpperCase() + u;
  }
  e.toFirstUpper = $, f($, "toFirstUpper");
  function s(r, n, u) {
    return r.split(n).join(u);
  }
  e.replaceAll = s, f(s, "replaceAll");
  function d(r, n) {
    return !r && !n ? !0 : !r || !n ? !1 : r.toLocaleLowerCase() === n.toLocaleLowerCase();
  }
  e.equalsIgnoreCase = d, f(d, "equalsIgnoreCase");
  function l(r, n) {
  ...
  e.ensureStartsWith = a, f(a, "ensureStartsWith");
  function p(r, n = " and ") {
    if (r.length === 0) return "";
    if (r.length === 1) return r[0];
    const u = r[r.length - 1];
    return `${r.slice(0, r.length - 1).join(", ")}${n}${u}`;
  }
  e.formatList = p, f(p, "formatList");
  function h(r, n) {
    const u = "abcdefghijklmnopqrstuvwxyz", x = "ABCDEFGHIJKLMNOPQRSTUVWXYZ", w = "0123456789";
    let k = "", F = !1, H = !1, U = !1;
  ...
  function b(r, n, u = 1, x, w = !0) {
    return E(r, n, u, (k, F) => k === F, x, w);
  }
  e.getUniqueName = b, f(b, "getUniqueName");
  function L(r, n, u = 1, x) {
    return E(r, n, u, (w, k) => w.toLocaleLowerCase() === k.toLocaleLowerCase(), x);
  }
  e.getUniqueNameIgnoreCase = L, f(L, "getUniqueNameIgnoreCase");
  function P(r, n, u) {
    const x = u?.checkForReservedWords ?? !0, w = u?.checkForLength ?? !0, k = w && !u?.characterLimit ? M.DEFAULT_CHARACTER_LIMIT : u?.characterLimit;
    return L(G.sanitizeName(r, x, w), n, u?.startSuffixIndex, k);
  }
  e.getSanitizedUniqueName = P, f(P, "getSanitizedUniqueName");
  function N(r, n) {
    if (r.length <= n) return r;
    const u = /.*(_\d+)$/.exec(r), x = u ? u[1] : "", w = n - x.length;
...
function E(e, t, i = 1, c, g, m = !0) {
  const $ = g ? e.substring(0, g) : e;
  if (!t.find((l) => c($, l))) return $;
  let s = i, d = $;
  do {
    const l = g ? e.substring(0, g - _e(s)) : $;
    d = m ? Oe(l, s) : l + s, s++;
  } while (t.find((l) => c(d, l)));
  return d;
}
...
Ze(({ type: e = "neutral", icon: t, children: i, button: c, onClose: g }) => o.jsxs(Re, { $type: e, $showBorder: !0, role: "alert", children: [t, o.jsx(qe, { children: i }), c ? o.jsx(R, { onPress: c.onClick, children: c.caption }) : null, g ? o.jsx(q, { icon: o.jsx(V, {}), onPress: g }) : null] }), "Alert");
...
const Xe = Ke((e) => o.jsx(S, { light: Je, dark: Ge, ...e }), "ExternalLinkIcon");
var Ye = Object.defineProperty, et = (e, t) => Ye(e, "name", { value: t, configurable: !0 });
const tt = et(({ children: e, href: t, ...i }) => o.jsxs(rt, { href: t, ...i, children: [e ?? t, t && o.jsx(Xe, {})] }), "Link"), rt = y(pe)`
...
const it = at(({ type: e = "info", title: t, children: i, link: c, button: g, onClose: m }) => o.jsxs(st, { $type: e, role: "alert", children: [X(e), o.jsxs(lt, { children: [t ? o.jsx(ct, { children: t }) : null, o.jsx(dt, { children: i }), c ? o.jsx(tt, { href: c.href, target: "_blank", rel: "external noreferrer", children: c.caption }) : null, g ? o.jsx(R, { onPress: g.onClick, children: g.caption }) : null] }), m ? o.jsx(ot, { icon: o.jsx(V, {}), onPress: m }) : null] }), "InlineAlert"), st = y.div`
    display: flex;
    flex-direction: row;
    gap: ${v.spacing8};
    justify-content: stretch;
...
`, T = ({ children: e, type: t, onClose: i, transparent: c }) => /* @__PURE__ */ o.jsx(ut, { $transparent: c, children: /* @__PURE__ */ o.jsx(it, { type: t, onClose: i, children: e }) }), gt = (e) => /* @__PURE__ */ o.jsx(T, { ...e, type: "info" }), ht = (e) => /* @__PURE__ */ o.jsx(T, { ...e, type: "warning" }), pt = (e) => /* @__PURE__ */ o.jsx(T, { ...e, type: "danger" }), mt = (e) => /* @__PURE__ */ o.jsx(T, { ...e, type: "success" });
export {
  pt as E,
  gt as I,
  mt as S,
