import { j as r, p as i, al as s, ag as a, af as p, aE as k, aI as h, aJ as $ } from "./TextInputWithIcon-mWdTJJox.js";
...
const N = J((e) => r.jsx(i, { light: T, dark: H, ...e }), "CheckmarkIcon"), U = a.div`
    [role="alert"] {
        align-items: start;
        & > img {
            margin-top: 5px;
...
`, g = ({
  ...
  return /* @__PURE__ */ r.jsx(U, { children: /* @__PURE__ */ r.jsx(
    S,
    {
      ...
      icon: o,
      onClose: n,
      button: f ? { caption: c, onClick: d } : void 0,
      children: e
    }
  ) });
}, z = (e) => /* @__PURE__ */ r.jsx(g, { ...e, type: "info", icon: /* @__PURE__ */ r.jsx($, {}) }), K = (e) => /* @__PURE__ */ r.jsx(g, { ...e, type: "warning", icon: /* @__PURE__ */ r.jsx(R, {}) }), Q = (e) => /* @__PURE__ */ r.jsx(g, { ...e, type: "success", icon: /* @__PURE__ */ r.jsx(N, {}) });
export {
  z as I,
  Q as S,
  K as W
};
//# sourceMappingURL=Banner-B6MbUbzd.js.map
