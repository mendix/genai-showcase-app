import { r as a, J as n, aj as r, I as k } from "./PageContainers-1sk3OYaf.js";
import { f as C, e as h, M as t } from "./compatibilityUtils-Chr7KNop.js";
...
const M = [
  ...
  const [o, d] = a.useState([]), [g, p] = a.useState("2.2.0"), [m, i] = a.useState(!0), [u, l] = a.useState(!1), s = a.useCallback(async () => {
    i(!0), l(!1);
    try {
      ...
      d(b);
      const f = c.find((I) => I.name === "AgentEditor");
      p(f?.appStoreVersion || "2.2.0");
    } catch {
      l(!0);
    } finally {
      i(!1);
