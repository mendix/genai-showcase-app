  ...
  async loaded(e) {
    ...
    try {
      if (await t.app.model.customBlobDocuments.registerDocumentType({
        ...
        const { createStudioProLogger: n } = await import("./logger-gMbuSAUF.js"), { createAnalyticsService: o } = await import("./analytics-DSd6ibhT.js"), { createDocumentReferenceSyncService: s } = await import("./documentReferenceSync-C3DMj9zn.js"), i = N(e), a = ge(e), d = n(i), l = await Oe(i), De = o(a, l, d), ye = s(i, d);
