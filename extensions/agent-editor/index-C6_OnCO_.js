...
const f = "data:image/png;base64,", C = "data:image/png;base64,", D = "data:image/png;base64,", O = "AE001", b = "AE002", I = "AE003", M = "AE004", v = "AE005", x = "AE006", _ = "AE007", B = "AE008", k = "AE009", F = "AE010", N = "AE011", ue = [
  ...
  F,
  N
], L = "AE101", P = "AE102", S = "AE103", U = "AE104", Ae = [
  L,
  P,
  S,
  U
], K = "AE201", V = "AE202", q = "AE203", G = "AE204", z = "AE205", Y = "AE206", Q = "AE207", H = "AE208", me = [
  K,
  V,
  q,
  G,
  ...
  Q,
  H
], X = "AE301", j = "AE302", J = "AE303", W = "AE304", Ee = [
  X,
  j,
  J,
  W
  ...
  Microflow: "Microflow",
  MCP: "MCP"
}, ye = ["v2025_03_26", "v2024_11_05"], fe = ye[0], je = async (o, t) => {
...
}, Re = (o) => "microflowActionInfo" in o, ge = (o) => ({
  check: async (t) => {
    const e = await we(o, t), n = await he(o, t), r = Oe(t), s = await be(o, t);
    return {
...
async function be(o, t) {
  ...
  for (const r of t.tools) {
    ...
    const s = await De(o, r.toolType, r.document.documentId), i = Te(r.toolType);
    if (!s)
      e.push({
        elementText: "Tools",
        errorCode: B,
...
const Me = (o) => ({
  check: async (t) => {
    const e = await ve(o, t), n = await xe(o, t);
    return {
...
async function et(o, t, e) {
  const n = e.systemPrompt.match(/\{\{([^}]+)\}\}/g) || [], r = e.userPrompt ? e.userPrompt.match(/\{\{([^}]+)\}\}/g) || [] : [], s = t === ae, i = [...n, ...r];
  if (i.length === 0)
    return Promise.resolve([]);
  const A = i.map((d) => d.replace(/\{\{|\}\}/g, "")), oe = [...new Set(A)], re = e.variables, ne = oe.map((d) => re.find((ie) => ie.key === d) || {
    key: d,
...
async function Ue(o, t, e) {
  const n = await Ke(o, e), r = await te(e, o);
  return t.map((s) => {
...
const Ke = async (o, t) => t.entity ? await c(o, t.entity.qualifiedName) !== void 0 : !0, ot = async (o, t) => t.variables.length === 0 ? [] : !t.entity || !await c(o, t.entity.qualifiedName) ? [] : t.variables.filter((e) => !e.isAttributeInEntity).map((e) => e.key), te = async (o, t) => {
  if (!o.entity)
    return [];
  const e = await c(t, o.entity.qualifiedName);
  return e ? (await $(t, e)).sort() : [];
}, rt = async (o, t) => (await te(t, o)).filter((n) => !t.variables.find((r) => r.key === n));
function Ve() {
  return {
    protocolVersion: fe
  };
}
const nt = (o, t) => async (e) => {
  const n = h(o);
  try {
    await o.app.model.customBlobDocuments.updateDocumentContent(t, e);
  } catch (r) {
...
}, st = "extension/agent-editor", T = "agenteditor.agent", R = "agenteditor.model", g = "agenteditor.consumedMCPService", w = "agenteditor.knowledgebase";
class qe {
  async loaded(t) {
    const e = ce(t), n = h(e);
    try {
      await e.app.model.customBlobDocuments.registerDocumentType({
        ...
        defaultContent: le(),
        consistencyCheckRegistration: _e(e)
      }), await e.ui.editors.registerEditorForCustomDocument({
        documentType: w,
        editorKind: "tab",
...
//# sourceMappingURL=index-C6_OnCO_.js.map
