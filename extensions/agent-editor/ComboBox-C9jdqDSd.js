import { r as a, e as me, ab as Re, b as Ce, aN as Kl, y as Pl, $ as je, a as Bl, g as Dt, aO as Ue, aP as be, i as J, aQ as He, u as $e, aR as ye, az as Ge, w as Oe, aS as lt, f as wl, aT as ae, ac as Et, v as We, aU as Tl, j as se, aV as kl, aW as Fl, B as S, aX as ot, aY as Ml, aZ as Il, Q as At, x as it, aA as Ll, a_ as Rl, q as Kt, a$ as Ol, n as Vl, b0 as ut, s as we, b1 as zl, b2 as Pt, b3 as rt, a3 as Bt, b4 as Nl, a5 as jl, b5 as wt, o as qe, H as Ul, l as Hl, a2 as Gl, R as de, I as Xe, b6 as Wl, M as Tt, X as Ye, U as Ze, aa as ql, a6 as Xl, P as Yl, a8 as Zl, V as kt, K as Jl, L as Ql, O as _l, W as eo, Y as Ft, Z as Mt, b7 as It, _ as to, a0 as no, b8 as Lt, a1 as lo, ad as le, b9 as oo, ai as Rt, ae as Z, ba as io, aj as Ot, ag as uo, bb as ro, ak as so, aq as ao, aK as co } from "./TextInputWithIcon-D0NqO6mp.js";
import { r as ee } from "./DesignSystemTokens-XeI_xSox.js";
function fo(t, e) {
...
function Oo(t, e, n) {
  ...
  delete w.id;
  let H = Ll(K == null ? void 0 : K.props);
  return {
    optionProps: {
      ...E,
      ...J(w, O, X, H),
...
function Qo(t) {
  let [e] = a.useState(() => new Ho((t == null ? void 0 : t()) || new jl())), n = a.useCallback((u) => e.subscribe(u), [
    e
  ]), l = a.useCallback(() => {
...
function ai(t) {
  ...
  let { collection: m, selectionManager: x, selectedKey: y, setSelectedKey: C, selectedItem: P, disabledKeys: B } = si({
    ...
    n,
    t.items
  ]), [N, j] = a.useState(k), R = a.useRef("focus"), w = Ul({
    ...t,
    onOpenChange: (L) => {
  ...
  let ie = Hl({
    ...
    if (t.selectedKey !== void 0 && t.inputValue !== void 0) {
      ...
      var G;
      let Al = y != null && (G = (U = m.getItem(y)) === null || U === void 0 ? void 0 : U.textValue) !== null && G !== void 0 ? G : "";
      V(Al), d();
    } else
      W(), d();
  };
  ...
  let Y = () => {
    ...
    L ? (ue.current = E, l === "focus" && !t.isReadOnly && H(null, "focus")) : (u && I(), E !== ue.current && ie.commitValidation()), h(L);
...
function ml({ state: t, props: e, listBoxRef: n }) {
  ...
  let { focusProps: X, isFocused: w, isFocusVisible: H } = Yl(), v = r.collection.size === 0, D = {
    isDropTarget: N,
    isEmpty: v,
    isFocused: w,
    isFocusVisible: H,
...
function wi({ props: t, collection: e, comboBoxRef: n }) {
  ...
  let p = (s = (r = t.validationBehavior) !== null && r !== void 0 ? r : u) !== null && s !== void 0 ? s : "native", { contains: h } = xo({
  ...
  }), f = a.useRef(null), b = a.useRef(null), $ = a.useRef(null), m = a.useRef(null), [x, y] = kt(!t["aria-label"] && !t["aria-labelledby"]), { buttonProps: C, inputProps: P, listBoxProps: B, labelProps: E, descriptionProps: K, errorMessageProps: z, ...T } = Uo({
    ..._l(t),
    label: y,
    inputRef: b,
    buttonRef: f,
    ...
    if (b.current) {
      var H;
      let v = (H = f.current) === null || H === void 0 ? void 0 : H.getBoundingClientRect(), D = b.current.getBoundingClientRect(), F = v ? Math.min(v.left, D.left) : D.left, d = v ? Math.max(v.right, D.right) : D.right;
      k(d - F + "px");
    }
  }, [
    f,
...
`, lu = ({
  ...
  return a.useEffect(() => {
    ...
    c && p(c);
  }, [e]), /* @__PURE__ */ Z.jsx(Mi, { ref: s, className: r, children: /* @__PURE__ */ Z.jsx(
    Ii,
    {
      value: e,
      onChange: h,
...
}, Li = "data:image/svg+xml,%3csvg%20width='16'%20height='16'%20viewBox='0%200%2016%2016'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M5.2449%206H10.7549C10.9449%206%2011.0599%206.16%2010.9649%206.29L8.3949%209.795C8.1949%2010.07%207.7999%2010.07%207.5999%209.795L5.0299%206.29C4.9349%206.16%205.0549%206%205.2399%206H5.2449Z'%20fill='%23A4A4A4'/%3e%3c/svg%3e", Ri = "data:image/svg+xml,%3csvg%20width='16'%20height='16'%20viewBox='0%200%2016%2016'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M5.2449%206H10.7549C10.9449%206%2011.0599%206.16%2010.9649%206.29L8.3949%209.795C8.1949%2010.07%207.7999%2010.07%207.5999%209.795L5.0299%206.29C4.9349%206.16%205.0549%206%205.2399%206H5.2449Z'%20fill='%23535965'/%3e%3c/svg%3e";
var Oi = Object.defineProperty, Vi = (t, e) => Oi(t, "name", { value: e, configurable: !0 });
const zi = Vi((t) => Z.jsx(uo, { light: Ri, dark: Li, ...t }), "ExpandedSplitButtonIcon");
var Ni = Object.defineProperty, Sl = (t, e) => Ni(t, "name", { value: e, configurable: !0 });
function Dl(t) {
  return Z.jsx(Ui, { ...t });
}
...
Sl(ji, "DropdownListBoxItem");
const Ui = le(yi)``, Hi = le(Ci)`
    ...
    line-height: ${ee.lineHeightMd};
`;
var Gi = Object.defineProperty, Wi = (t, e) => Gi(t, "name", { value: e, configurable: !0 });
function El({ children: t, label: e, description: n, items: l, onInputChange: o, ...i }) {
  ...
  return Z.jsx(Yi, { ...i, onInputChange: f, isInvalid: p, validate: h, children: Z.jsxs(Ot, { label: e, description: n, realtimeValidationError: c, children: [Z.jsxs(Zi, { children: [Z.jsx(Ji, {}), Z.jsx(Qi, { "aria-hidden": "true", icon: Z.jsx(zi, {}) })] }), Z.jsx(so, { children: Z.jsx(Dl, { items: l, children: t }) })] }) });
}
Wi(El, "ComboBox");
const qi = "16px", Xi = `${qi} + ${ee.spacing4} * 2`, Yi = le(Pi)``, Zi = le.div`
    position: relative;
    line-height: ${ee.lineHeightMd};
    flex: 1;
`, Ji = le(ao)`
    padding-right: calc(${Xi});
    overflow: hidden;
    text-overflow: ellipsis;
    white-space: nowrap;
    width: 100%;
...
//# sourceMappingURL=ComboBox-C9jdqDSd.js.map
