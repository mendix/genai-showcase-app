import { a as F, $ as w, c as k, b as m, U as H, V, W as M, r as h, j as y, s as D, q as E, t as L, u as j, w as P, x as T, z as B } from "./Icon-B4HLWuEl.js";
...
function O(s, e) {
  ...
  return {
    ...
    linkProps: m(p, C, {
      ...
      onClick: (x) => {
        var u;
        (u = i.onClick) === null || u === void 0 || u.call(i, x), M(x, g, s.href, s.routerOptions);
      }
    })
  };
}
...
var U = Object.defineProperty, _ = (s, e) => U(s, "name", { value: e, configurable: !0 });
const q = _((s) => P.jsx(T, { light: R, dark: I, ...s }), "ExternalLinkIcon");
var N = Object.defineProperty, W = (s, e) => N(s, "name", { value: e, configurable: !0 });
const K = W(({ children: s, href: e, ...t }) => P.jsxs(A, { href: e, ...t, children: [s ?? e, e && P.jsx(q, {})] }), "Link"), A = B(z)`
...
//# sourceMappingURL=Link-DWBff6VF.js.map
