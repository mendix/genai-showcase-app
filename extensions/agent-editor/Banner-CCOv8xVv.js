import { ae as r, ag as c, al as s, ad as a, aG as w, aK as p, aL as f } from "./TextInputWithIcon-D0NqO6mp.js";
import { r as g } from "./DesignSystemTokens-XeI_xSox.js";
...
var C = Object.defineProperty, i = (e, t) => C(e, "name", { value: t, configurable: !0 });
function h(e) {
...
const V = T((e) => r.jsx(c, { light: R, dark: E, ...e }), "CheckmarkIcon"), K = a.div`
    [role="alert"] {
        align-items: start;
        padding: 8px 8px;
        & > button {
...
`, l = ({ children: e, type: t, icon: o, onClose: n }) => /* @__PURE__ */ r.jsx(K, { children: /* @__PURE__ */ r.jsx(S, { type: t, icon: o, onClose: n, children: e }) }), q = (e) => /* @__PURE__ */ r.jsx(l, { ...e, type: "info", icon: /* @__PURE__ */ r.jsx(f, {}) }), z = (e) => /* @__PURE__ */ r.jsx(l, { ...e, type: "warning", icon: /* @__PURE__ */ r.jsx(W, {}) }), J = (e) => /* @__PURE__ */ r.jsx(l, { ...e, type: "success", icon: /* @__PURE__ */ r.jsx(V, {}) });
export {
  q as I,
  J as S,
  z as W
};
//# sourceMappingURL=Banner-CCOv8xVv.js.map
