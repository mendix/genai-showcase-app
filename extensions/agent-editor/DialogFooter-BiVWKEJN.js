import { z as s, y as i, w as r, av as p, bd as x, r as u, be as g, x as h, bf as f, T as n } from "./TextInputWithIcon-BrxzJg1N.js";
var m = Object.defineProperty, c = (t, e) => m(t, "name", { value: e, configurable: !0 });
const v = c(({ children: t, ...e }) => r.jsx(p, { children: r.jsx(C, { children: r.jsx(j, { ...e, children: t }) }) }), "ButtonFooter"), C = c(({ children: t }) => {
  const e = x(), a = u.useCallback((o) => {
...
//# sourceMappingURL=DialogFooter-BiVWKEJN.js.map
