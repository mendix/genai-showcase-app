...
import { d as c, m as u } from "./modelUtils-DczGW_ri.js";
...
const Q = async (n, t) => t.entity ? await i(n, t.entity) !== void 0 : !0, N = async (n, t) => t.variables.length === 0 ? [] : !t.entity || !await i(n, t.entity) ? [] : t.variables.filter((e) => !e.isAttributeInEntity).map((e) => e.key), B = async (n, t) => {
  if (!n.entity)
    return [];
  const e = await i(t, n.entity);
  return e ? (await b(t, e)).sort() : [];
}, q = async (n, t) => (await B(t, n)).filter((A) => !t.variables.find((o) => o.key === A)), j = {
  Microflow: "Microflow",
  MCP: "MCP"
...
}, _ = "extension/agent-editor", g = "agenteditor.agent", E = "agenteditor.model", C = "agenteditor.consumedMCPService", y = "agenteditor.knowledgebase";
class K {
  async loaded(t) {
    const e = h(t), A = p(e);
    try {
...
//# sourceMappingURL=index-BKrcCp8a.js.map
