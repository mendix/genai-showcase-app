import { y as s, w as t, ax as p, bf as x, r as g, bg as h, x as u, bh as f, T as n } from "./TextInputWithIcon-Bxcjz2pl.js";
import { r as i } from "./logger-CC_FxqwC.js";
...
const C = c(({ children: r, ...e }) => t.jsx(p, { children: t.jsx(v, { children: t.jsx(j, { ...e, children: r }) }) }), "ButtonFooter"), v = c(({ children: r }) => {
  ...
  return t.jsx(w, { role: "presentation", onKeyDownCapture: a, children: r });
...
var y = Object.defineProperty, F = (r, e) => y(r, "name", { value: e, configurable: !0 });
const P = F((r) => t.jsx(u, { light: k, dark: $, ...r }), "HelpIcon");
...
`, E = ({
  ...
  d && /* @__PURE__ */ t.jsx(D, { onPress: a }),
  /* @__PURE__ */ t.jsx(b, {}),
  /* @__PURE__ */ t.jsx(n, { variant: "primary", onPress: r, children: o }),
  /* @__PURE__ */ t.jsx(n, { onPress: e, children: l })
] });
export {
  E as D
};
//# sourceMappingURL=DialogFooter-BWIHywC0.js.map
