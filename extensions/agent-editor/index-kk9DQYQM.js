...
import { getComponentFramework as Oe } from "@mendix/component-framework";
...
import { T as Re, e as he, f as we, i as Ne, j as Ie, g as Me, C as be } from "./toolUtils-3GFu_U6Y.js";
import { g as x } from "./customBlobDocumentUtils-DRHCWWx0.js";
import { C as ke, a as _e } from "./compatibility-B4OgVO3B.js";
import { a as m, i as p } from "./constantUtils-D0RXxXWn.js";
import { i as T, m as f, h as y, k as D, j as xe, d as Se, e as Be, g as ve } from "./documentInitUtils-CvQbsMH5.js";
...
const qt = 300, A = {
  ...
  Z,
  $
], O = "AE101", R = "AE102", h = "AE103", w = "AE104", ee = "AE105", te = "AE106", oe = "AE107", ne = "AE108", We = [
  O,
  R,
  h,
  w,
...
const yt = (o) => ({
  check: async (e) => {
    let t;
    return e.provider === "MxCloudGenAI" ? t = await Dt(o, e) : e.provider === "Azure" && (t = await gt(o, e)), {
      errors: t ? [...t.errors] : [],
...
async function Tt(o, e) {
  try {
    o.app.projectChanges.addEventListener("elementsRenamed", async ({ elements: t }) => {
      await Rt(o, t), await ht(o, t), await Nt(o, t), await wt(o, t);
    });
  } catch (t) {
...
async function wt(o, e) {
  const t = await o.app.model.customBlobDocuments.getDocumentsOfType(D);
  for (const r of t) {
    const n = await o.app.model.customBlobDocuments.getDocumentById(r.id);
    if ("document" in n && n.document && n.document.contents.provider === "MxCloudGenAI") {
      const i = n.document.contents.providerFields;
...
const ge = "extension/agent-editor";
class It {
  async loaded(e) {
    const t = Ce(e);
    try {
      if (await t.app.model.customBlobDocuments.registerDocumentType({
        ...
        const { createStudioProLogger: r } = await import("./logger-gMbuSAUF.js"), { createAnalyticsService: n } = await import("./analytics-BKTYkI-2.js"), i = I(e), s = Ue(e), a = r(i), l = await Ke(i), E = n(s, l, a);
