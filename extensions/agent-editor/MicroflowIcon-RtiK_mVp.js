import { y as d, W as m, w as a, X as u, Y as h, Z as f, x as g } from "./Icon-CjmU6z_u.js";
import { r } from "./DesignSystemTokens-CB_9gr2a.js";
var w = Object.defineProperty, p = (e, o) => w(e, "name", { value: o, configurable: !0 });
function v({ label: e, description: o, rows: t, cols: s, ...i }) {
  const { isInvalid: n, validationError: l, validate: c } = m(i);
  return a.jsx(u, { ...i, isInvalid: n, validate: c, children: a.jsx(h, { label: e, description: o, realtimeValidationError: l, children: a.jsx($, { rows: t, cols: s }) }) });
}
p(v, "TextArea");
const $ = d(f)`
...
`, I = {
  ...
  const t = await x(e, o.documentId);
  if (!t)
  ...
  if (!o)
    return null;
  try {
    return await e.app.model.microflows.load(
...
var k = Object.defineProperty, M = (e, o) => k(e, "name", { value: o, configurable: !0 });
const H = M((e) => a.jsx(g, { light: C, dark: b, ...e }), "MicroflowIcon");
export {
  I as C,
  x as g,
  D as h,
...
//# sourceMappingURL=MicroflowIcon-RtiK_mVp.js.map
