import { w as r, x as c, aB as s, y as i, T as w, aN as p, aO as f } from "./TextInputWithIcon-DVt8kRsz.js";
...
const T = N((e) => r.jsx(c, { light: R, dark: E, ...e }), "CheckmarkIcon"), V = i.div`
    [role="alert"] {
        align-items: start;
        padding: 8px 8px;
        & > button {
...
`, l = ({ children: e, type: t, icon: o, onClose: n }) => /* @__PURE__ */ r.jsx(V, { children: /* @__PURE__ */ r.jsx(S, { type: t, icon: o, onClose: n, children: e }) }), z = (e) => /* @__PURE__ */ r.jsx(l, { ...e, type: "info", icon: /* @__PURE__ */ r.jsx(f, {}) }), J = (e) => /* @__PURE__ */ r.jsx(l, { ...e, type: "warning", icon: /* @__PURE__ */ r.jsx(W, {}) }), K = (e) => /* @__PURE__ */ r.jsx(l, { ...e, type: "success", icon: /* @__PURE__ */ r.jsx(T, {}) });
export {
  z as I,
  K as S,
  J as W
};
//# sourceMappingURL=Banner-BJQE2gAx.js.map
