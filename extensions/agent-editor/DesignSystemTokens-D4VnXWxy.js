...
function hr(o, e) {
  var i, d, g, p, h, A, I, E, R, F, j, W, $, z, H, _, V, Y, w;
  if (e == null)
    return {
      text: "",
...
function Jr() {
  ...
  const u = {
    ...
    prettyFormatErrorObj(a, l) {
      const B = g(u.getErrorTrace(a), l), f = Fr(a).map((y, G) => {
...
`), L = A(a), D = y ? a : L;
      if (h(y)) {
        ...
        const S = H(k.prettyInspectOptions, l), m = f != null ? I(k, f) : { text: L, styles: [] }, M = m.text.length > 0 && m.styles.length > 0, N = (M ? m.text : L) + S + G;
        M ? console.log(N, ...m.styles) : console.log(N);
        return;
      }
      k.prettyInspectOptions.colors = y;
      const b = H(k.prettyInspectOptions, l);
      console.log(D + b + G);
    },
    transportJSON(a) {
      console.log(pr(a));
  ...
  function i(a) {
    ...
    const N = V(M), Q = N.length > 0 ? N : M, dr = Q.split(/\\|\//), er = dr[dr.length - 1], Pr = er && D ? `${er}:${D}` : void 0, wr = Q && D ? `${Q}:${D}` : void 0;
    return {
      fullFilePath: G,
      fileName: er,
      fileNameWithLine: Pr,
...
{{errorStack}}`,
  ...
  log(e, t, ...n) {
    var I, E, R, F, j, W, $, z, H, _, V, Y;
    if (e < this.settings.minLevel)
      return;
    const c = this._resolveLogArguments(n), u = [...this.settings.prefix, ...c], s = ((I = this.settings.overwrite) == null ? void 0 : I.mask) != null ? (E = this.settings.overwrite) == null ? void 0 : E.mask(u) : this.settings.maskValuesOfKeys != null && this.settings.maskValuesOfKeys.length > 0 ? this._mask(u) : u, i = this.logObj != null ? this._recursiveCloneAndExecuteFunctions(this.logObj) : void 0, d = ((R = this.settings.overwrite) == null ? void 0 : R.toLogObj) != null ? (F = this.settings.overwrite) == null ? void 0 : F.toLogObj(s, i) : this._toLogObj(s, i), g = ((j = this.settings.overwrite) == null ? void 0 : j.addMeta) != null ? (W = this.settings.overwrite) == null ? void 0 : W.addMeta(d, e, t) : this._addMetaToLogObj(d, e, t), p = g == null ? void 0 : g[this.settings.metaProperty];
    let h, A;
    if ((($ = this.settings.overwrite) == null ? void 0 : $.formatMeta) != null && (h = (z = this.settings.overwrite) == null ? void 0 : z.formatMeta(g == null ? void 0 : g[this.settings.metaProperty])), ((H = this.settings.overwrite) == null ? void 0 : H.formatLogObj) != null && (A = (_ = this.settings.overwrite) == null ? void 0 : _.formatLogObj(s, this.settings)), this.settings.type === "pretty" && (h = h ?? this._prettyFormatLogObjMeta(g == null ? void 0 : g[this.settings.metaProperty]), A = A ?? C.prettyFormatLogObj(s, this.settings)), h != null && A != null)
...
let le;
const Be = { name: "light", get devTokens() {
...
let ce;
const fe = { name: "dark", get devTokens() {
...
//# sourceMappingURL=DesignSystemTokens-D4VnXWxy.js.map
