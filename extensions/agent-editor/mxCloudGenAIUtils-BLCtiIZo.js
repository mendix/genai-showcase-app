import { a as F, $ as A, c as h, b as y, M as D, N as M, O as I, r as x, j as B, s as H, q as V, t as j, u as N, w as $, x as U, y as G } from "./Icon-DL4Zg1xv.js";
import { r as k, c as f } from "./DesignSystemTokens-CB_9gr2a.js";
import { g as b } from "./ButtonWithLabel-AZ8aIohf.js";
import { d as L } from "./modelUtils-IL_KjN2R.js";
function K(e, r) {
  let { elementType: s = "a", onPress: t, onPressStart: o, onPressEnd: n, onClick: i, isDisabled: a, ...d } = e, c = {};
  s !== "a" && (c = {
    role: "link",
    tabIndex: a ? void 0 : 0
  });
...
const O = /* @__PURE__ */ x.createContext(null), S = /* @__PURE__ */ x.forwardRef(function(r, s) {
  ...
  let t = r.href && !r.isDisabled ? "a" : "span", { linkProps: o, isPressed: n } = K({
    ...r,
    elementType: t
  }, s), { hoverProps: i, isHovered: a } = H(r), { focusProps: d, isFocused: c, isFocusVisible: l } = V(), u = j({
    ...r,
...
var _ = Object.defineProperty, q = (e, r) => _(e, "name", { value: r, configurable: !0 });
const Q = q((e) => $.jsx(U, { light: z, dark: J, ...e }), "ExternalLinkIcon");
var R = Object.defineProperty, W = (e, r) => R(e, "name", { value: r, configurable: !0 });
const ae = W(({ children: e, href: r, ...s }) => $.jsxs(X, { href: r, ...s, children: [e ?? r, r && $.jsx(Q, {})] }), "Link"), X = G(S)`
...
`, Y = (e, r) => {
  ...
  try {
    ...
    if (a.status !== 200)
      throw new Error(`HTTP ${a.status}: ${a.statusText}`);
    const d = await a.json(), c = [];
    return d.content.forEach((l) => c.push({ name: l.name })), c;
  } catch (t) {
    return s.error("Error invoking MxCloud GenAI resource API:", t), t instanceof Error ? t.message : "";
  }
};
...
//# sourceMappingURL=mxCloudGenAIUtils-BLCtiIZo.js.map
