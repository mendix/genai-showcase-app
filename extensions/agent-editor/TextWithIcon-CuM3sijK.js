import { r as c, L as s, I as t, ae as j, af as y, S as v } from "./Icon-DYNjIYYQ.js";
import { G as E, H as w } from "./index-YObaGbux.js";
...
const $ = ({
  ...
  f.current = o, c.useEffect(() => {
    const p = ({ documents: x }) => {
      const d = [];
      for (const a of x)
        m.current && a.documentType === E && a.moduleName && m.current.includes(a.moduleName) ? d.push("domainModel") : f.current && a.documentType === w ? d.push("projectSettings") : u.current.includes(a.documentId) && d.push(a.documentId);
...
//# sourceMappingURL=TextWithIcon-CuM3sijK.js.map
