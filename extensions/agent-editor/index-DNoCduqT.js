...
import { a as Me, b as ke, o as be, g as _e, M as u, r as Pe, s as xe, m as Se } from "./settings-7VMAPLzn.js";
...
import { a as ze, T as Fe, e as Ke, f as Ye, i as Ve, j as Xe, g as je, C as He } from "./toolUtils-MLHoVQt4.js";
  ...
  async loaded(e) {
    ...
    try {
      if (await n.app.model.customBlobDocuments.registerDocumentType({
        ...
        const { createStudioProLogger: t } = await import("./logger-gMbuSAUF.js"), { createAnalyticsService: o } = await import("./analytics-Bu9vEdQD.js"), { createDocumentReferenceSyncService: i } = await import("./documentReferenceSync-JffUYhY3.js"), s = _(e), a = be(e), l = t(s), R = await _e(s), he = o(a, R, l), Ie = i(s, l);
