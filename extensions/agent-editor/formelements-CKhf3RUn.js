...
import { J as i, I as o, ad as $, al as m, ae as v, am as w, an as y, r as h, ao as I } from "./PageContainers-1sk3OYaf.js";
var j = Object.defineProperty, k = (e, a) => j(e, "name", { value: a, configurable: !0 });
function f({ label: e, description: a, rows: s, cols: n, ...l }) {
  const { isInvalid: d, validationError: c, validate: p } = $(l);
  return t.jsx(m, { ...l, isInvalid: d, validate: p, children: t.jsx(v, { label: e, description: a, realtimeValidationError: c, children: t.jsx(w, { children: ({ inputRef: x }) => t.jsx(S, { rows: s, cols: n, ref: x }) }) }) });
}
k(f, "TextArea");
const S = o(y)`
