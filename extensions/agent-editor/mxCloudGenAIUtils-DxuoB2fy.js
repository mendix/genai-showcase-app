import { a as E, $ as T, c as g, b as $, M as D, N as M, O as A, r as h, j as H, s as I, q as V, t as B, u as N, w as k, x as j, y as L } from "./Icon-DL4Zg1xv.js";
import { r as b, c as m } from "./DesignSystemTokens-CB_9gr2a.js";
import { g as x } from "./ButtonWithLabel-AZ8aIohf.js";
import { d as O } from "./modelUtils-IL_KjN2R.js";
function S(r, e) {
  ...
  return {
    ...
    linkProps: $(v, F, {
      ...
      onClick: (y) => {
        var p;
        (p = d.onClick) === null || p === void 0 || p.call(d, y), A(y, C, r.href, r.routerOptions);
      }
    })
  };
}
const U = /* @__PURE__ */ h.createContext(null), G = /* @__PURE__ */ h.forwardRef(function(e, s) {
  [e, s] = H(e, s, U);
  let t = e.href && !e.isDisabled ? "a" : "span", { linkProps: o, isPressed: n } = S({
    ...e,
    elementType: t
...
//# sourceMappingURL=mxCloudGenAIUtils-DxuoB2fy.js.map
