...
import { g as u } from "./toolHandlers-C5CHV-Dt.js";
const l = async (t, e, i, s) => {
  const a = i.knowledgebaseTools, r = i.tools;
  switch (t) {
    case "name":
    ...
    case "maxResults":
      ...
      break;
    case "minSimilarity":
      if (console.log(e), e.minSimilarity !== void 0 && e.minSimilarity !== null) {
...
//# sourceMappingURL=knowledgebaseToolHandlers-xqstHokh.js.map
