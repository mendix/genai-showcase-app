import { r as u, T as c, aj as f, S as k } from "./PageContainers-B4e_cfEm.js";
import { M as r, b as g } from "./compatibility-B4OgVO3B.js";
import { m as v } from "./documentInitUtils-CvQbsMH5.js";
...
const O = (t, n) => {
  ...
  const [n, e] = u.useState([]), [o, a] = u.useState("2.1.0"), [s, i] = u.useState(!0), [l, d] = u.useState(!1), m = u.useCallback(async () => {
    i(!0), d(!1);
    try {
