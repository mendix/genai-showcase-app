import { r as a, a8 as me, aA as Re, a5 as Ce, aT as Dl, ah as El, a3 as je, a4 as Al, $ as Dt, aU as Ue, aV as be, b as Z, aW as He, aX as ye, ad as $e, F as Ge, af as Oe, aY as lt, a9 as Kl, aZ as se, aK as Et, ae as We, a_ as Pl, c as ue, a$ as Bl, b0 as wl, u as S, b1 as ot, b2 as Tl, b3 as Fl, s as At, ag as it, H as kl, b4 as Ml, aa as Kt, b5 as Il, g as Ll, b6 as ut, ab as we, b7 as Rl, b8 as Pt, aC as Bt, b9 as wt, ba as rt, bb as Ol, aF as Vl, h as qe, ap as zl, e as Nl, aE as jl, t as de, j as Ye, bc as Ul, n as Tt, au as Xe, ar as Ze, aB as Hl, aG as Gl, q as Wl, aI as ql, as as Ft, l as Yl, m as Xl, p as Zl, at as Jl, av as kt, aw as Mt, bd as It, ax as Ql, ay as _l, be as Lt, az as eo, w as _, x as to, y as re, bf as no, W as lo, Y as oo, aQ as io, aR as uo, a2 as ro } from "./Icon-DjcrVRZV.js";
import { r as ce } from "./DesignSystemTokens-CB_9gr2a.js";
function so(t, e) {
...
function xn(t) {
  ...
  let { addGlobalListener: s, removeGlobalListener: p } = Al(), { pressProps: b } = Dt({
    isDisabled: e,
    onPressStart(f) {
...
function Dn(t) {
    ...
    const k = (g, I) => {
      if (g != null) {
        if (e.isLink(g) && m === "selection" && p && !Ve(v)) {
          ...
          let X = xe(l, g), oe = e.getItemProps(g);
          X && y.open(X, v, oe.href, oe.routerOptions);
          return;
        }
    ...
    switch (v.key) {
      case "ArrowDown":
        if (n.getKeyBelow) {
          ...
          g == null && i && (g = (V = n.getFirstKey) === null || V === void 0 ? void 0 : V.call(n, e.focusedKey)), g != null && (v.preventDefault(), k(g));
        }
        break;
      case "ArrowUp":
        if (n.getKeyAbove) {
          ...
          g == null && i && (g = (te = n.getLastKey) === null || te === void 0 ? void 0 : te.call(n, e.focusedKey)), g != null && (v.preventDefault(), k(g));
        }
        break;
      case "ArrowLeft":
        if (n.getKeyLeftOf) {
          ...
          g == null && i && (g = x === "rtl" ? (Q = n.getFirstKey) === null || Q === void 0 ? void 0 : Q.call(n, e.focusedKey) : (ne = n.getLastKey) === null || ne === void 0 ? void 0 : ne.call(n, e.focusedKey)), g != null && (v.preventDefault(), k(g, x === "rtl" ? "first" : "last"));
        }
        break;
      case "ArrowRight":
        if (n.getKeyRightOf) {
          ...
          g == null && i && (g = x === "rtl" ? (ie = n.getLastKey) === null || ie === void 0 ? void 0 : ie.call(n, e.focusedKey) : (A = n.getFirstKey) === null || A === void 0 ? void 0 : A.call(n, e.focusedKey)), g != null && (v.preventDefault(), k(g, x === "rtl" ? "last" : "first"));
        }
        break;
      case "Home":
        if (n.getFirstKey) {
  ...
  he($, "scroll", h ? void 0 : () => {
    var v, D, k, d;
    P.current = {
      top: (k = (v = $.current) === null || v === void 0 ? void 0 : v.scrollTop) !== null && k !== void 0 ? k : 0,
  ...
  let B = (v) => {
    ...
    if (v.currentTarget.contains(v.target)) {
      if (e.setFocused(!0), e.focusedKey == null) {
        ...
        var d, M;
        W && v.currentTarget.compareDocumentPosition(W) & Node.DOCUMENT_POSITION_FOLLOWING ? V((d = e.lastSelectedKey) !== null && d !== void 0 ? d : (D = n.getLastKey) === null || D === void 0 ? void 0 : D.call(n)) : V((M = e.firstSelectedKey) !== null && M !== void 0 ? M : (k = n.getFirstKey) === null || k === void 0 ? void 0 : k.call(n));
  ...
  let z = Ce(() => {
    var v, D;
    let k = (D = (v = n.getFirstKey) === null || v === void 0 ? void 0 : v.call(n)) !== null && D !== void 0 ? D : null;
    if (k == null) {
      let d = He();
      mn(l.current), Qe(d, null), e.collection.size > 0 && (K.current = !1);
    } else
      e.setFocusedKey(k), K.current = !1;
  });
  st(() => {
    K.current && z();
  }, [
  ...
  const O = a.useRef(o), F = a.useRef(!1);
  a.useEffect(() => {
    if (O.current) {
      var v, D;
      let M = null;
      var k;
      o === "first" && (M = (k = (v = n.getFirstKey) === null || v === void 0 ? void 0 : v.call(n)) !== null && k !== void 0 ? k : null);
      var d;
      ...
      e.setFocused(!0), e.setFocusedKey(M), M == null && !c && l.current && Oe(l.current), e.collection.size > 0 && (O.current = !1, F.current = !0);
    }
  });
  let N = a.useRef(e.focusedKey), j = a.useRef(null);
  a.useEffect(() => {
    if (e.isFocused && e.focusedKey != null && (e.focusedKey !== N.current || F.current) && $.current && l.current) {
      let v = lt(), D = xe(l, e.focusedKey);
      if (!(D instanceof HTMLElement))
        return;
      (v === "keyboard" || F.current) && (j.current && cancelAnimationFrame(j.current), j.current = requestAnimationFrame(() => {
        $.current && (Rt($.current, D), v !== "virtual" && ct(D, {
          containingElement: l.current
        }));
      }));
    }
    !c && e.isFocused && e.focusedKey == null && N.current != null && l.current && Oe(l.current), N.current = e.focusedKey, F.current = !1;
  }), a.useEffect(() => () => {
...
function Ko(t) {
  ...
  let m = n.isLink(l) && c === "override", x = p && t.UNSTABLE_itemBehavior === "action", y = n.isLink(l) && c !== "selection" && c !== "none", C = !s && n.canSelectItem(l) && !m && !x, P = (p || y) && !s, B = P && (n.selectionBehavior === "replace" ? !C : !C || n.isEmpty), E = P && C && n.selectionBehavior === "replace", K = B || E, z = a.useRef(null), T = K && C, O = a.useRef(!1), F = a.useRef(!1), N = n.getItemProps(l), j = (d) => {
    if (p) {
      var M;
  ...
  if (i ? (R.onPressStart = (d) => {
    ...
    z.current = d.pointerType, O.current = T, F.current = B, C && (d.pointerType === "mouse" && !B || d.pointerType === "keyboard" && (!P || ft())) && h(d);
  }, R.onPress = (d) => {
    (d.pointerType === "touch" || d.pointerType === "pen" || d.pointerType === "virtual" || d.pointerType === "keyboard" && K && dt() || d.pointerType === "mouse" && F.current) && (K ? j(d) : C && h(d));
  }), $["data-collection"] = So(n.collection), $["data-key"] = l, R.preventFocusOnPress = u, u && (R = Z(R, {
    onPressStart(d) {
    ...
    if (S.isValidElement(u)) {
      ...
      for (; !P.done && P.value; ) {
        ...
        for (let T of z) {
          ...
          var c;
          if (e.type && T.type !== e.type) throw new Error(`Unsupported type <${ke(T.type)}> in <${ke((c = o == null ? void 0 : o.type) !== null && c !== void 0 ? c : "unknown parent type")}>. Only <${ke(e.type)}> is supported.`);
          C++, yield T;
        }
        P = y.next(z);
      }
...
function Io(t, e, n) {
  ...
  Tl() && Fl() || (E["aria-label"] = t["aria-label"], E["aria-labelledby"] = P, E["aria-describedby"] = B);
  ...
  } : void 0, T = Cn(e, i), { itemProps: O, isPressed: F, isFocused: N, hasAction: j, allowsSelection: R } = Ko({
    selectionManager: e.selectionManager,
    key: i,
    ref: n,
  ...
  }), w = ue(K == null ? void 0 : K.props);
  delete w.id;
  let H = kl(K == null ? void 0 : K.props);
  return {
    optionProps: {
      ...E,
      ...Z(w, O, Y, H),
...
function Oo(t, e, n) {
  ...
  }, b = Kt(Ro(ul), "@react-aria/menu"), { longPressProps: c } = xn({
...
function zo(t, e) {
  ...
  n = n ?? c;
  let f = Kt(Vo(yn), "@react-aria/combobox"), { menuTriggerProps: h, menuProps: $ } = Oo({
    type: "listbox",
    isDisabled: b || p
  }, e, n);
  Se.set(e, {
  ...
  let { collection: m } = e, { disabledKeys: x } = e.selectionManager, y = a.useMemo(() => u || new _e({
    ...
    var g;
    let I = (n == null ? void 0 : n.current) && n.current === A.relatedTarget, X = (g = l.current) === null || g === void 0 ? void 0 : g.contains(A.relatedTarget);
    I || X || (t.onBlur && t.onBlur(A), e.setFocused(!1));
  }, K = (A) => {
    e.isFocused || (t.onFocus && t.onFocus(A), e.setFocused(!0));
  }, { isInvalid: z, validationErrors: T, validationDetails: O } = e.displayValidation, { labelProps: F, inputProps: N, descriptionProps: j, errorMessageProps: R } = Il({
    ...t,
    ...
    let I = A.target.getBoundingClientRect(), X = A.changedTouches[0], oe = Math.ceil(I.left + 0.5 * I.width), Ke = Math.ceil(I.top + 0.5 * I.height);
    if (X.clientX === oe && X.clientY === Ke) {
      var pe;
  ...
  a.useEffect(() => {
    if (ye() && d != null && q != null && q !== J.current) {
      let g = e.selectionManager.isSelected(q), I = V != null ? e.collection.getItem(V) : null, X = (I == null ? void 0 : I["aria-label"]) || (typeof (I == null ? void 0 : I.rendered) == "string" ? I.rendered : "") || "";
      var A;
      let oe = f.format("focusAnnouncement", {
        isGroupChange: (A = I && V !== te.current) !== null && A !== void 0 ? A : !1,
        groupTitle: X,
        groupCount: I ? [
          ...De(I, e.collection)
        ].length : 0,
  ...
  a.useEffect(() => {
    let A = e.isOpen !== le.current && (e.selectionManager.focusedKey == null || ye());
    if (e.isOpen && (A || Q !== ne.current)) {
...
function cl(t) {
  if (a.useContext(ve))
    return t.content;
  let { collection: n, document: l } = Xo(t.createCollection);
    ...
    let e = [], n = (l) => {
      for (; l != null; ) {
        if (this.canSelectItem(l)) {
          ...
          var i;
          u != null && u.hasChildNodes && (this.allowsCellSelection || u.type !== "item") && n((i = (o = ko(De(u, this.collection))) === null || o === void 0 ? void 0 : o.key) !== null && i !== void 0 ? i : null);
        }
...
function hl(t) {
  ...
  ]), r = Fo(t, i, u), s = a.useMemo(() => new tt(r, l, {
    layoutDelegate: n
  }), [
    r,
    l,
...
function ui(t) {
  ...
  let { collection: m, selectionManager: x, selectedKey: y, setSelectedKey: C, selectedItem: P, disabledKeys: B } = ii({
  ...
  }), [E, K] = qe(t.inputValue, St(t.defaultInputValue, y, m) || "", t.onInputChange), [z] = a.useState(y), [T] = a.useState(E), O = m, F = a.useMemo(() => (
    ...
    n,
    t.items
  ]), [N, j] = a.useState(F), R = a.useRef("focus"), w = zl({
    ...t,
    onOpenChange: (L) => {
    ...
    (o || F.size > 0 || G && O.size > 0 || t.items) && (G && !w.isOpen && t.items === void 0 && s(!0), R.current = U, f(L), w.open());
  }, v = (L = null, U) => {
    let G = U === "manual" || U === "focus" && l === "focus";
    !(o || F.size > 0 || G && O.size > 0 || t.items) && !w.isOpen || (G && !w.isOpen && t.items === void 0 && s(!0), w.isOpen || (R.current = U), k(L));
  }, D = a.useCallback(() => {
    j(r ? O : F);
  }, [
    r,
  ...
  a.useEffect(() => {
    var L;
    p && (F.size > 0 || o) && !w.isOpen && E !== M && l !== "manual" && H(null, "input"), !r && !o && w.isOpen && F.size === 0 && d(), y != null && y !== J.current && d(), E !== M && (x.setFocusedKey(null), s(!1), E === "" && (t.inputValue === void 0 || t.selectedKey === void 0) && C(null)), y !== J.current && (t.inputValue === void 0 || t.selectedKey === void 0) ? W() : M !== E && V(E);
    var U;
    let G = y != null && (U = (L = m.getItem(y)) === null || L === void 0 ? void 0 : L.textValue) !== null && U !== void 0 ? U : "";
    !p && y != null && t.inputValue === void 0 && y === J.current && ne.current !== G && (V(G), K(G)), J.current = y, ne.current = G;
  });
  let le = Nl({
    ...t,
    value: a.useMemo(() => ({
...
bi.type = "separator";
const Ae = /* @__PURE__ */ a.createContext(null), fe = /* @__PURE__ */ a.createContext(null), vi = /* @__PURE__ */ a.forwardRef(function(e, n) {
  [e, n] = Ye(e, n, Ae);
...
function yl({ state: t, props: e, listBoxRef: n }) {
  ...
  let T, O, F, N = !1, j = null, R = a.useRef(null);
  if (b && l) {
  ...
  return /* @__PURE__ */ S.createElement(ql, null, /* @__PURE__ */ S.createElement("div", {
    ...Z(M, k, E, Y, F == null ? void 0 : F.collectionProps),
    ref: n,
    slot: e.slot || void 0,
    onScroll: e.onScroll,
...
function gi(t, e, n, l = "react-aria-ListBoxSection") {
  let o = a.useContext(fe), { dragAndDropHooks: i, dropState: u } = a.useContext(Ee), { CollectionBranch: r } = a.useContext(et), [s, p] = Ft();
  var b;
...
const yi = /* @__PURE__ */ fl(Ul, function(e, n, l) {
  ...
  return delete B.id, delete B.onClick, /* @__PURE__ */ S.createElement(P, {
    ...Z(B, C, p, h, m == null ? void 0 : m.dragProps, x == null ? void 0 : x.dropProps),
    ref: o,
...
function Ki({ props: t, collection: e, comboBoxRef: n }) {
  let { name: l, formValue: o = "key", allowsCustomValue: i } = t;
  i && (o = "text");
  let { validationBehavior: u } = Yl(Xl) || {};
  var r, s;
  let p = (s = (r = t.validationBehavior) !== null && r !== void 0 ? r : u) !== null && s !== void 0 ? s : "native", { contains: b } = $o({
  ...
  }), f = a.useRef(null), h = a.useRef(null), $ = a.useRef(null), m = a.useRef(null), [x, y] = Ft(!t["aria-label"] && !t["aria-labelledby"]), { buttonProps: C, inputProps: P, listBoxProps: B, labelProps: E, descriptionProps: K, errorMessageProps: z, ...T } = zo({
    ...Zl(t),
    label: y,
    inputRef: h,
    buttonRef: f,
    ...
    validationBehavior: p
  }, c), [O, F] = a.useState(null), N = a.useCallback(() => {
    if (h.current) {
      var H;
      let v = (H = f.current) === null || H === void 0 ? void 0 : H.getBoundingClientRect(), D = h.current.getBoundingClientRect(), k = v ? Math.min(v.left, D.left) : D.left, d = v ? Math.max(v.right, D.right) : D.right;
      F(d - k + "px");
    }
  }, [
    f,
...
const Fi = Ti((t) => _.jsx(to, { light: Bi, dark: Pi, ...t }), "ExpandedSplitButtonIcon");
var ki = Object.defineProperty, xl = (t, e) => ki(t, "name", { value: e, configurable: !0 });
function ml(t) {
  return _.jsx(Ii, { ...t });
}
...
function Cl({ children: t, label: e, description: n, items: l, onInputChange: o, ...i }) {
  ...
  return _.jsx(Ni, { ...i, onInputChange: f, isInvalid: p, validate: b, children: _.jsxs(oo, { label: e, description: n, realtimeValidationError: c, children: [_.jsxs(ji, { children: [_.jsx(Ui, {}), _.jsx(Hi, { "aria-hidden": "true", icon: _.jsx(Fi, {}) })] }), _.jsx(io, { children: _.jsx(ml, { items: l, children: t }) })] }) });
}
Oi(Cl, "ComboBox");
...
//# sourceMappingURL=ComboBox-B8hY_AzW.js.map
