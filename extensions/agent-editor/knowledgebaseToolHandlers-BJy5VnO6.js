import { g as m } from "./toolHandlers-Dh0W5--3.js";
const c = async (t, e, i, s) => {
  ...
  switch (t) {
    ...
    case "document": {
      ...
      if (!await m(s, e.document.documentId))
...
//# sourceMappingURL=knowledgebaseToolHandlers-BJy5VnO6.js.map
