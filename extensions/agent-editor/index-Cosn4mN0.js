import { a as Ee, c as O } from "./index-CE9RqUwp.js";
...
const lt = 300, u = {
  ...
  Tool: "Tool",
  Any: "Any"
}, b = "AE001", B = "AE002", S = "AE003", v = "AE004", L = "AE005", x = "AE006", k = "AE007", G = "AE008", P = "AE009", U = "AE010", q = "AE011", Q = "AE012", V = "AE013", K = "AE014", Y = "AE015", z = "AE016", X = "AE017", F = "AE018", ye = [
  b,
  B,
  S,
  v,
  ...
  X,
  F
], H = "AE101", J = "AE102", j = "AE103", _ = "AE104", ge = [
  H,
  J,
  j,
  _
], W = "AE201", Z = "AE202", $ = "AE203", ee = "AE204", te = "AE205", oe = "AE206", ne = "AE207", re = "AE208", Te = [
  W,
  Z,
  $,
  ee,
  ...
  ne,
  re
], se = "AE301", ie = "AE302", ae = "AE303", ce = "AE304", De = [
  se,
  ie,
  ae,
  ce
...
}, gt = "Action not found.", Tt = "https://docs.mendix.com/refguide/runtime-tab/#after-startup", Dt = "Settings$ProjectSettings", Rt = "DomainModels$DomainModel", we = "DomainModels$Entity", le = "Microflows$Microflow", D = "Constants$Constant", Oe = "Projects$Module", wt = async (o, t) => {
  const e = await y(o, t);
  if (!e)
...
const ht = async (o, t, e) => {
  ...
  check: async (t) => {
    const e = await Be(o, t), r = Se(t), n = await ve(o, t), s = Le(t), i = xe(t), a = ke(t), l = await Ge(o, t), w = await Pe(o, t);
    return {
      errors: [
        ...e.errors,
        ...n.errors,
...
async function ve(o, t) {
  ...
  const n = await T(o, t.entity.qualifiedName);
  if (!n)
    return e.push({
      elementText: "Context entity",
      errorCode: x,
...
async function Ye(o, t) {
  ...
  return n ? n.excluded ? (e.push({
    ...
    severity: "error",
    elementText: "Authentication microflow"
  }), (n.microflowReturnType.$Type !== "DataTypes$ListType" || n.microflowReturnType.entity !== g.HttpHeader) && e.push({
    errorCode: oe,
  ...
  async loaded(t) {
    ...
    try {
      if (await e.app.model.customBlobDocuments.registerDocumentType({
        ...
        const r = O(t), { createStudioProLogger: n } = await import("./logger-Bof2Evv1.js"), s = n(r);
        tt(r, s);
        let i = !1;
      ...
      if (t.runMode === "ui") {
        const n = O(t), { createStudioProLogger: s } = await import("./logger-Bof2Evv1.js");
