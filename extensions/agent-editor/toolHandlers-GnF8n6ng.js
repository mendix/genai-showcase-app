...
import { T as h, z as W, A as D } from "./index-BUxpXATg.js";
const M = v.div`
    position: absolute;
    top: 0;
    left: 0;
...
`, N = ({
  ...
  const x = l.useRef(null), y = l.useRef(null), [k, A] = l.useState(0), z = g || 5, T = m && m.length > 0, C = () => {
    if (!T) return null;
    const t = [];
    m.forEach((i, c) => {
  ...
  return l.useEffect(() => {
    ...
    /* @__PURE__ */ a.jsx(j, { fullWidth: !0, children: /* @__PURE__ */ a.jsxs(P, { ref: x, children: [
      T && /* @__PURE__ */ a.jsxs(a.Fragment, { children: [
        /* @__PURE__ */ a.jsx(R, {}),
        /* @__PURE__ */ a.jsx(M, { ref: y, style: { paddingRight: `${2 + k}px` }, children: C() })
      ] }),
      /* @__PURE__ */ a.jsx(
        q,
        {
...
//# sourceMappingURL=toolHandlers-GnF8n6ng.js.map
